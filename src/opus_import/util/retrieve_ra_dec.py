...
radec_pat = re.compile(
    r'Coordinates.ICRS,ep=J2000,eq=2000.: '
...
def main() -> None:
    ...
    for key in STARS:
        ...
        if star_id == 'LMC 303':
            star_id = '@3114237'
        params = {'output.format': 'ASCII', 'Ident': star_id.lower()}
        ...
        ra = (ra_h + ra_m / 60.0 + ra_s / 60.0 / 60.0) * 360.0 / 24.0
        dec = dec_d + dec_m / 60.0 + dec_s / 60.0 / 60.0
        if dec_sign == '-':
            dec = -dec
