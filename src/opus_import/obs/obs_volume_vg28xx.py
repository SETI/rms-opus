...
class ObsVolumeVG28xx(ObsVolumeVoyagerCommon):
    ...
    def field_obs_wavelength_wavelength1(self) -> FloatField:
        return cast(FloatField, self._supp_index_col('MINIMUM_WAVELENGTH'))

    def field_obs_wavelength_wavelength2(self) -> FloatField:
        return cast(FloatField, self._supp_index_col('MAXIMUM_WAVELENGTH'))
    ...
    def field_obs_ring_geometry_projected_radial_resolution1(self) -> FloatField:
        return cast(FloatField, self._supp_index_col('MINIMUM_RADIAL_RESOLUTION'))

    def field_obs_ring_geometry_projected_radial_resolution2(self) -> FloatField:
        return cast(FloatField, self._supp_index_col('MAXIMUM_RADIAL_RESOLUTION'))
