...
class ObsVolumeCORSS8xxx(ObsVolumeCassiniOccCommon):
    ...
    def field_obs_general_time2(self) -> FloatField:
        return self._time2_from_supp_index(
            self.field_obs_general_time1(), column='EARTH_RECEIVED_STOP_TIME'
        )
    ...
    def field_obs_profile_source(self) -> MultFieldRet:
        ...
        return self._create_mult(col_val='CASSINI', disp_name='Cassini', disp_order='!Cassini')
    ...
    def field_obs_ring_geometry_emission1(self) -> FloatField:
        return cast(FloatField, 180.0 - self._index_col('MAXIMUM_LIGHT_SOURCE_INCIDENCE_ANGLE'))

    def field_obs_ring_geometry_emission2(self) -> FloatField:
        return cast(FloatField, 180.0 - self._index_col('MINIMUM_LIGHT_SOURCE_INCIDENCE_ANGLE'))

    def field_obs_ring_geometry_north_based_incidence1(self) -> FloatField:
        return cast(FloatField, 90.0 + self._index_col('MINIMUM_OBSERVED_RING_ELEVATION'))

    def field_obs_ring_geometry_north_based_incidence2(self) -> FloatField:
        return cast(FloatField, 90.0 + self._index_col('MAXIMUM_OBSERVED_RING_ELEVATION'))
