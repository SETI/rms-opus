...
def getMenuLabels(request, labels_view):
    ...
    for d in divs:
        ...
        if d.table_name == 'obs_surface_geometry':
            menu_data[d.table_name]['menu_help'] = "Select a target name to reveal more options. Supported Instruments: NHLORRI, COISS, COUVIS, COVIMS, and early COCIRS"

        if d.table_name == 'obs_ring_geometry':
            menu_data[d.table_name]['menu_help'] = "Supported Instruments: NHLORRI, COISS, COUVIS, COVIMS, and early COCIRS"
