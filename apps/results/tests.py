...
class resultsTests(TestCase):
    ...
    def test__get_base_path_previews(self):
        rms_obs_id = 'S_SPEC_CO_CIRS_1633035651_FP4'
        preview = get_base_path_previews(rms_obs_id)
    ...
    def test__getFiles(self):
        rms_obs_id = 'S_IMG_CO_ISS_1688230146_N'
        product_types = ['CALIBRATED','RAW_IMAGE']
        files = getFiles(rms_obs_id, fmt='raw', loc_type="path", product_types=product_types)
        print files[rms_obs_id]
        ...
        print 'expected:'
        print expected[rms_obs_id]
        self.assertEqual(len(files[rms_obs_id]['CALIBRATED']), len(expected[rms_obs_id]['CALIBRATED']))
    ...
    def test__metadata_J_IMG_CO_ISS_1353756055_W(self):
        rms_obs_id = 'J_IMG_CO_ISS_1353756055_W'
        detail, all_info = get_metadata({},rms_obs_id=rms_obs_id,fmt='raw')
        print detail
        print detail['Cassini Mission Constraints']
