...
class resultsTests(TestCase):
    ...
    def test__get_triggered_tables_target_NEPTUNE(self):
        ...
        partables = get_triggered_tables(selections, extras)
        expected = sorted([u'obs_general',  u'obs_surface_geometry', u'obs_wavelength', u'obs_ring_geometry', u'obs_mission_voyager', u'obs_instrument_VGISS'])
        print 'partables:'
        print partables
        print 'expected:'
        print expected
    ...
    def test__get_metadata(self):
        response = self.c.get('/opus/api/metadata/S_IMG_CO_ISS_1686170143_N.json')
