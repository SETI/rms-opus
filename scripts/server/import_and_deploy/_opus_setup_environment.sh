...
# The import pipeline is an installed package now, so it locates the secrets file by
# this variable instead of by the directory it happens to be invoked from.
