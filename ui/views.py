...
def getWidget(request, **kwargs):
    ...
    # MULT form types
        ...
        # determine if this mult param has a grouping field (see README.txt for howto on grouping fields)
...
def getDetailPage(request, **kwargs):                    
    ...
    files = getFiles(ring_obs_id=ring_obs_id,fmt='raw')[ring_obs_id]
    file_list = {} 
