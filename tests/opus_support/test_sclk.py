...
def test_parse_sclk_omitted_final_field(
    parser: Callable[[str], float], omitted: str, written_out: str
) -> None:
...
@pytest.mark.parametrize(
    ...
    [
        # Partition handling.
        ('1/2/03464059.00', 'Invalid Galileo clock format, extraneous slash: 1/2/03464059:00'),
        ...
        ('1/03464059.450', 'Galileo clock field 2 "450" has too many digits: 03464059:450'),
        ('1/034640590.00', 'Galileo clock leading field has too many digits: 034640590:00'),
        ...
        ('1/-34640590.00', 'Galileo clock leading field has too many digits: -34640590:00'),
        # Wrong number of fields, or fields that are individually too long.
        ('01234567:000', 'Galileo clock field 2 "000" has too many digits: 01234567:000'),
        ('01234567:00:91', 'Galileo clock field 3 "91" has too many digits: 01234567:00:91'),
        ('01234567:00:-2', 'Galileo clock field 3 "-2" has too many digits: 01234567:00:-2'),
        ('01234567:00:00', 'Galileo clock field 3 "00" has too many digits: 01234567:00:00'),
        ('01234567:00:0:00', 'Galileo clock field 4 "00" has too many digits: 01234567:00:0:00'),
        ('01234567:00:0:8', 'Galileo clock field 4 out of range 0-7: 01234567:00:0:8'),
        ('01234567:00:0:a', 'Galileo clock fields must be integers: 01234567:00:0:a'),
        ('01234567:00:0:0:0', 'More than 4 Galileo clock fields: 01234567:00:0:0:0'),
    ],
)
...
@pytest.mark.parametrize(
    ('sclk', 'message'),
    [
        ('1/2/0003103485:49000', 'New Horizons partition number must be one: 2/0003103485:49000'),
        ('4/0003103485:49000', 'New Horizons partition number must be 1 or 3: 4/0003103485:49000'),
        ('2/0003103485:49000', 'New Horizons partition number must be 1 or 3: 2/0003103485:49000'),
        ('0/0003103485:49000', 'New Horizons partition number must be 1 or 3: 0/0003103485:49000'),
        (
            '1.0/0003103485:49000',
            'New Horizons partition number must be 1 or 3: 1.0/0003103485:49000',
        ),
        (
            '-1/0003103485:49000',
            'New Horizons partition number must be 1 or 3: -1/0003103485:49000',
        ),
        ('a/0003103485:49000', 'New Horizons partition number must be 1 or 3: a/0003103485:49000'),
        ('/0003103485:49000', 'New Horizons partition number must be 1 or 3: /0003103485:49000'),
        (
            '1/0003103485:49000:49000',
            'More than 2 New Horizons clock fields: 0003103485:49000:49000',
        ),
        ('1/a', 'New Horizons clock fields must be integers: a'),
        ('1/000310348a', 'New Horizons clock fields must be integers: 000310348a'),
        ('1/0003103485:4900a', 'New Horizons clock fields must be integers: 0003103485:4900a'),
        (
            '1/0003103485:-10000',
            'New Horizons clock field 2 "-10000" has too many digits: 0003103485:-10000',
        ),
        ('1/0003103485:50000', 'New Horizons clock field 2 out of range 0-49999: 0003103485:50000'),
        ('1/0003103485:99999', 'New Horizons clock field 2 out of range 0-49999: 0003103485:99999'),
        (
            '1/00003103485:49000',
            'New Horizons clock leading field has too many digits: 00003103485:49000',
        ),
        ...
        (
            '1/-0003103485:00000',
            'New Horizons clock leading field has too many digits: -0003103485:00000',
        ),
        # The partition must agree with the clock count it is paired with.
        ('1/0150000000:00001', 'New Horizons partition number is invalid: 1/0150000000:00001'),
        ('3/0149999999:49999', 'New Horizons partition number is invalid: 3/0149999999:49999'),
    ],
)
def test_parse_new_horizons_sclk_rejects_bad_input(sclk: str, message: str) -> None:
...
@pytest.mark.parametrize(
    ...
    [
        (
            '1/2/1294341579.000',
            'Invalid Cassini clock format, extraneous slash: 1/2/1294341579.000',
        ),
        ('2/1294341579.000', 'Cassini partition number must be one: 2/1294341579.000'),
        ('0/1294341579.000', 'Cassini partition number must be one: 0/1294341579.000'),
        ('1.0/1294341579.000', 'Cassini partition number must be one: 1.0/1294341579.000'),
        ('-1/1294341579.000', 'Cassini partition number must be one: -1/1294341579.000'),
        ('a/1294341579.000', 'Cassini partition number must be one: a/1294341579.000'),
        ('/1294341579.000', 'Cassini partition number must be one: /1294341579.000'),
        ('1/1294341579.000.000', 'More than 2 Cassini clock fields: 1294341579.000.000'),
        ('1/a', 'Cassini clock fields must be integers: a'),
        ('1/0123456a', 'Cassini clock fields must be integers: 0123456a'),
        ('1/1294341579.00a', 'Cassini clock fields must be integers: 1294341579.00a'),
        ('1/1294341579.-1', 'Cassini clock field 2 out of range 0-255: 1294341579.-1'),
        ('1/1294341579.256', 'Cassini clock field 2 out of range 0-255: 1294341579.256'),
        ('1/1294341579.2560', 'Cassini clock field 2 "2560" has too many digits: 1294341579.2560'),
        ('1/01294341579.000', 'Cassini clock leading field has too many digits: 01294341579.000'),
        ...
        ('1/-34640590.000', 'Cassini clock leading field has too many digits: -34640590.000'),
    ],
)
...
@pytest.mark.parametrize(
    ('sclk', 'message'),
    [
        ('1/2/08966:30:752', 'Invalid FDS format, extraneous "/": 1/2/08966:30:752'),
...
def test_parse_voyager_sclk_rejects_unknown_planet(planet: int) -> None:
    ...
    with pytest.raises(AssertionError, match=re.escape(f'Invalid planet value: {planet}')):
...
@pytest.mark.parametrize(
    ('sclk', 'planet', 'message'),
    [
        ('1/08966:30:752', 5, 'Partition number for Jupiter flyby must be 2: 1/08966:30:752'),
        ('3/08966:30:752', 5, 'Partition number for Jupiter flyby must be 2: 3/08966:30:752'),
        ('1/08966:30:752', 6, 'Partition number for Saturn flyby must be 2: 1/08966:30:752'),
        ('3/08966:30:752', 6, 'Partition number for Saturn flyby must be 2: 3/08966:30:752'),
        ('1/08966:30:752', 7, 'Partition number for Uranus flyby must be 3: 1/08966:30:752'),
        ('2/08966:30:752', 7, 'Partition number for Uranus flyby must be 3: 2/08966:30:752'),
        ('1/08966:30:752', 8, 'Partition number for Neptune flyby must be 4: 1/08966:30:752'),
        ('5/08966:30:752', 8, 'Partition number for Neptune flyby must be 4: 5/08966:30:752'),
    ],
)
def test_parse_voyager_sclk_rejects_wrong_partition_for_planet(
    sclk: str, planet: int, message: str
) -> None:
...
def test_parse_voyager_sclk_accepts_matching_partition(sclk: str, planet: int | None) -> None:
    """A partition consistent with the flyby (or with no planet) is accepted."""
    assert parse_voyager_sclk(sclk, planet=planet) == pytest.approx(0, abs=SCLK_ABS_TOL)
...
def test_format_voyager_sclk_accepts_dot_separator(fields: int, expected: str) -> None:
...
def test_format_voyager_sclk_rejects_out_of_range_hours() -> None:
    ...
    with pytest.raises(
        ValueError, match=re.escape('Voyager clock "hours" cannot exceed 65535: 65536')
    ):
