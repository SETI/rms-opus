...
def test_an_unset_variable_means_the_local_database(
...
def test_an_empty_variable_means_the_local_database(
        monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_a_known_target_is_returned_unchanged(monkeypatch: pytest.MonkeyPatch,
                                              target: str) -> None:
...
def test_an_unknown_target_stops_the_run(monkeypatch: pytest.MonkeyPatch,
                                         target: str) -> None:
