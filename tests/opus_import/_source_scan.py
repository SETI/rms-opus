...
Both were written and both were fixed in one file during PR-16; the second was then
reintroduced a few hundred lines below the first, in the same file, by a scan written
later. Hence this module: import the traversal instead of writing it, so the correct
one is the only one reachable.
"""
