"""Golden-response tests for the results API: data, images, files and metadata."""
...
class ApiResultsTests(ApiTestHelper, TestCase):
    """The results API, one recorded response per request."""
    ...
    def test__api_dataimages_corss_cols_units_page(self) -> None:
        "[test_results_api.py] /__api/dataimages: corss search & cols & units"
    ...
    def test__api_dataimages_corss_cols_units_cart(self) -> None:
    ...
    def test__api_dataimages_corss_cols_units_cart_recycle(self) -> None:
        "[test_results_api.py] /__api/dataimages: cart"
        url = '/__cart/reset.json?reqno=42'
        expected = {'recycled_count': 0, 'count': 0, 'reqno': 42}
        self._run_json_equal(url, expected)
    ...
    def test__api_dataimages_corss_startobs_cart(self) -> None:
    ...
    def test__api_dataimages_corss_page_cart(self) -> None:
    ...
    # fake
    def test__api_dataimages_no_results_default_reqno_fake(self) -> None:
    ...
    def test__api_data_no_results_default_json(self) -> None:
    ...
    def test__api_data_no_results_default_csv(self) -> None:
    ...
    def test__api_data_no_results_default_html(self) -> None:
    ...
    def test__api_data_no_results_empty_cols_json(self) -> None:
    ...
    def test__api_data_no_results_empty_cols_csv(self) -> None:
    ...
    def test__api_data_no_results_empty_cols_html(self) -> None:
    ...
    def test__api_data_coiss_2002_more_cols_json(self) -> None:
    ...
    def test__api_data_coiss_2002_more_cols_good_startobs_json(self) -> None:
    ...
    def test__api_data_coiss_2002_more_cols_units_csv(self) -> None:
    ...
    def test__api_data_coiss_2002_more_cols_html(self) -> None:
    ...
    def test__api_data_coiss_2002_more_cols_units_html(self) -> None:
    ...
    def test__api_data_coiss_2002_more_cols_units_json(self) -> None:
    ...
    def test__api_data_gossi_cols_units_order_target_json(self) -> None:
    ...
    def test__api_data_gossi_order_target_cart_json(self) -> None:
    ...
    def test__api_data_limit_all_csv(self) -> None:
        "[test_results_api.py] /api/data: limit all"
        url = '/api/data.csv?bundleid=CORSS_8001&cols=time1,time2&limit=all'
    ...
    def test__api_metadata_vg_iss_2_s_c4360845_default_startobs_json(self) -> None:
    ...
    def test__api_metadata_vg_iss_2_s_c4360845_default_page_startobs_limit_json(self) -> None:
    ...
    def test__api_metadata_vg_iss_2_s_c4360845_default_html_private(self) -> None:
    ...
    def test__api_metadata_vg_iss_2_s_c4360845_default_csv(self) -> None:
    ...
    def test__api_metadata_vg_iss_2_s_c4360845_cols_empty_json(self) -> None:
    ...
    def test__api_metadata_vg_iss_2_s_c4360845_cols_empty_html(self) -> None:
    ...
    def test__api_metadata_vg_iss_2_s_c4360845_cols_opusid_json(self) -> None:
    ...
    def test__api_metadata_nh_lorri_lor_0284457489_cols_opusid_json(self) -> None:
    ...
    def test__api_metadata_vg_iss_2_s_c4360845_cols_opusid_html(self) -> None:
    ...
    def test__api_metadata_vg_iss_2_s_c4365507_cols_all_cassini_csv(self) -> None:
        "[test_results_api.py] /api/metadata_v2: vg-iss-2-s-c4365507 cols all cassini csv"
        url = '/api/metadata/vg-iss-2-s-c4365507.csv?cols=opusid,bundleid,greaterpixelsize,lesserpixelsize,wavelength1,wavelength2,CASSINIobsname,CASSINIactivityname,CASSINImissionphasename,CASSINItargetcode,CASSINIrevnoint,CASSINIprimeinst,CASSINIisprime,CASSINIsequenceid,CASSINIspacecraftclockcount1,CASSINIspacecraftclockcount2,CASSINIert1,CASSINIert2'
        self._run_csv_equal_file(url, 'api_metadata_vg_iss_2_s_c4365507_cols_all_cassini_csv.csv')

    # Specified cats, empty
    def test__api_metadata_hst_09975_acs_j8n410lbq_cats_empty_json(self) -> None:
    ...
    def test__api_metadata_hst_09975_acs_j8n410lbq_cats_empty_html(self) -> None:
    ...
    def test__api_metadata_hst_09975_acs_j8n410lbq_cats_empty_csv(self) -> None:
