...
class ResultsTests(TestCase):
    ...
    def test__api_get_data_and_images_no_meta(self) -> None:
        ...
        with self.assertRaisesRegex(
            Http404, r'Internal error \(No request was provided\) for /__api/dataimages.json'
        ):
    ...
    def test__api_get_data_no_meta(self) -> None:
        ...
        request = request_without_meta(self.factory, 'dummy')
        with self.assertRaisesRegex(
            Http404, r'Internal error \(No request was provided\) for /api/data.json'
        ):
    ...
    def test__api_get_images_no_meta(self) -> None:
        ...
        request = request_without_meta(self.factory, 'dummy')
        with self.assertRaisesRegex(
            Http404, r'Internal error \(No request was provided\) for /api/images/None.json'
        ):
    ...
    def test__api_get_images_by_size_no_meta(self) -> None:
        ...
        request = request_without_meta(self.factory, 'dummy')
        with self.assertRaisesRegex(
            Http404, r'Internal error \(No request was provided\) for /api/images/small.json'
        ):
    ...
    def test__api_get_categories_for_search_no_meta(self) -> None:
        ...
        request = request_without_meta(self.factory, 'dummy')
        with self.assertRaisesRegex(
            Http404, r'Internal error \(No request was provided\) for /api/categories.json'
        ):
    ...
    def test__api_get_product_types_for_search_no_meta(self) -> None:
        ...
        request = request_without_meta(self.factory, 'dummy')
        with self.assertRaisesRegex(
            Http404, r'Internal error \(No request was provided\) for /api/product_types.json'
        ):
