...
class CartTests(TestCase):
    ...
    def test__api_view_cart_no_meta(self) -> None:
        ...
        with self.assertRaisesRegex(
            Http404, r'Internal error \(No request was provided\) for /__cart/view.html'
        ):
    ...
    def test__api_cart_status_no_meta(self) -> None:
        ...
        request = request_without_meta(self.factory, 'dummy')
        with self.assertRaisesRegex(
            Http404, r'Internal error \(No request was provided\) for /__cart/status.json'
        ):
    ...
    def test__api_get_cart_csv_no_meta(self) -> None:
        ...
        request = request_without_meta(self.factory, 'dummy')
        with self.assertRaisesRegex(
            Http404, r'Internal error \(No request was provided\) for /__cart/data.csv'
        ):
    ...
    def test__api_edit_cart_no_meta(self) -> None:
        ...
        request = request_without_meta(self.factory, 'dummy')
        with self.assertRaisesRegex(
            Http404, r'Internal error \(No request was provided\) for /__cart/add.json'
        ):
    ...
    def test__api_reset_session_no_meta(self) -> None:
        ...
        request = request_without_meta(self.factory, 'dummy')
        with self.assertRaisesRegex(
            Http404, r'Internal error \(No request was provided\) for /__cart/reset.json'
        ):
    ...
    def test__api_create_download_no_meta(self) -> None:
        ...
        request = request_without_meta(self.factory, 'dummy')
        with self.assertRaisesRegex(
            Http404, r'Internal error \(No request was provided\) for /__cart/download.json'
        ):
    ...
    def test__api_create_download_opusid_no_get(self) -> None:
        ...
        with self.assertRaisesRegex(
            Http404, r'Internal error \(No request was provided\) for /api/download/testopusid.zip'
        ):
