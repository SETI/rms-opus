...
Only the first is routed. The second is imported by nearly every other app, which is why
:mod:`opus_app.apps.search.views` is one of the largest modules in the project.
