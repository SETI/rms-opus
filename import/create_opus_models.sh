...
then
  ...
  sed -e "s/opus_id = models.ForeignKey(ObsGeneral, models.DO_NOTHING)/opus_id = models.ForeignKey(ObsGeneral, models.DO_NOTHING, related_name='%(class)s_opus_id')/g" < /tmp/__models.py > /tmp/_models.py
