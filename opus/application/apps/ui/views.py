    ...
    for d in divs:
        ...
        if labels_view == 'search':
            ...
            if table_name == 'obs_surface_geometry':
                menu_data[table_name]['menu_help'] = "Surface geometry, when available, is provided for all bodies in the field of view. Select a target name to reveal more options. Supported instruments: Cassini ISS, UVIS, and VIMS, New Horizons LORRI, and Voyager ISS."
