...
class ApiCartTests(TestCase, ApiTestHelper):
    ...
    def test__api_cart_add_download_two(self):
        ...
        self._run_json_equal(url, expected)
        url = '/__cart/add.json?opusid=co-iss-n1460960653&download=1&reqno=101010101'
        expected = {'total_download_count': 34, 'total_download_size': 30190800, 'total_download_size_pretty': '28M', 'product_cat_list': [['Cassini ISS-Specific Products', [{'slug_name': 'coiss_raw', 'tooltip': 'Raw image files (*.IMG) for Cassini ISS. Images are in VICAR format, uncalibrated, and in units of DN (data number). Associated labels (*.LBL) are text files that contain information about the image. Also included are tlmtab.fmt, which describes the format of the VICAR binary header, and prefix.fmt, which describes the format of the binary prefix at the beginning of each line of imaging data.', 'product_type': 'Raw image', 'product_count': 2, 'download_count': 6, 'download_size': 2185416, 'download_size_pretty': '2M', 'default_checked': 1}, {'slug_name': 'coiss_calib', 'tooltip': 'Calibrated image files (*_CALIB.IMG) for Cassini ISS. Images are in VICAR format and have been calibrated at the Ring-Moon Systems Node using the CISSCAL pipeline. They are in units of I/F. Associated labels (*.LBL) are text files that contain information about the image and its calibration.', 'product_type': 'Calibrated image', 'product_count': 2, 'download_count': 4, 'download_size': 8412579, 'download_size_pretty': '8M', 'default_checked': 1}, {'slug_name': 'coiss_thumb', 'tooltip': 'Thumbnail-size (50x50) non-linearly stretched preview JPEGs (*.jpeg_small) of observations, supplied by the Cassini Imaging team. The previews are not colored and the stretch may be different from the browse images produced by the Ring-Moon Systems Node.', 'product_type': 'Extra preview (thumbnail)', 'product_count': 2, 'download_count': 2, 'download_size': 1322, 'download_size_pretty': '1K', 'default_checked': 1}, {'slug_name': 'coiss_medium', 'tooltip': 'Medium-size (256x256) non-linearly stretched preview JPEGs (*.jpeg) of observations, supplied by the Cassini Imaging team. The previews are not colored and the stretch may be different from the browse images produced by the Ring-Moon Systems Node.', 'product_type': 'Extra preview (medium)', 'product_count': 2, 'download_count': 2, 'download_size': 7589, 'download_size_pretty': '7K', 'default_checked': 1}, {'slug_name': 'coiss_full', 'tooltip': 'Full-size non-linearly stretched preview PNGs or TIFFs (*.png or *.tiff) of observations, supplied by the Cassini Imaging team. The previews are not colored and the stretch may be different from the browse images produced by the Ring-Moon Systems Node.', 'product_type': 'Extra preview (full)', 'product_count': 2, 'download_count': 2, 'download_size': 721369, 'download_size_pretty': '704K', 'default_checked': 1}]], ['Metadata Products', [{'slug_name': 'rms_index', 'tooltip': 'Text files created by the Ring-Moon Systems Node that summarize or augment some metadata for all observations in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'RMS Node Augmented Index', 'product_count': 2, 'download_count': 2, 'download_size': 10170954, 'download_size_pretty': '9M', 'default_checked': 0}, {'slug_name': 'inventory', 'tooltip': 'Text files ([volume]_inventory.tab) that list every planet and moon inside the instrument field of view for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Target Body Inventory', 'product_count': 2, 'download_count': 2, 'download_size': 385596, 'download_size_pretty': '376K', 'default_checked': 1}, {'slug_name': 'planet_geometry', 'tooltip': 'Text files ([volume]_[planet]_summary.tab) that list the values of various surface geometry metadata for the central planet for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Planet Geometry Index', 'product_count': 2, 'download_count': 2, 'download_size': 1364814, 'download_size_pretty': '1M', 'default_checked': 1}, {'slug_name': 'moon_geometry', 'tooltip': 'Text files ([volume]_moon_summary.tab) that list the values of various surface geometry metadata for every moon in the field of view for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Moon Geometry Index', 'product_count': 2, 'download_count': 2, 'download_size': 4111515, 'download_size_pretty': '3M', 'default_checked': 1}, {'slug_name': 'ring_geometry', 'tooltip': 'Text files ([volume]_ring_summary.tab) that list the values of various ring plane intercept geometry metadata for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Ring Geometry Index', 'product_count': 2, 'download_count': 2, 'download_size': 2229982, 'download_size_pretty': '2M', 'default_checked': 1}]], ['Browse Products', [{'slug_name': 'browse_thumb', 'tooltip': 'Thumbnail-size (often 100x100) non-linearly stretched preview JPEGs (*_thumb.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (thumbnail)', 'product_count': 2, 'download_count': 2, 'download_size': 3049, 'download_size_pretty': '2K', 'default_checked': 1}, {'slug_name': 'browse_small', 'tooltip': 'Small-size (often 256x256) non-linearly stretched preview JPEGs (*_small.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (small)', 'product_count': 2, 'download_count': 2, 'download_size': 9179, 'download_size_pretty': '8K', 'default_checked': 1}, {'slug_name': 'browse_medium', 'tooltip': 'Medium-size (often 512x512) non-linearly stretched preview JPEGs (*_med.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (medium)', 'product_count': 2, 'download_count': 2, 'download_size': 23639, 'download_size_pretty': '23K', 'default_checked': 1}, {'slug_name': 'browse_full', 'tooltip': 'Full-size non-linearly stretched preview JPEGs (*_full.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are not colored. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (full)', 'product_count': 2, 'download_count': 2, 'download_size': 563797, 'download_size_pretty': '550K', 'default_checked': 1}]]], 'error': False, 'count': 2, 'recycled_count': 0, 'reqno': 101010101}
        self._run_json_equal(url, expected, ignore='tooltip')
        url = '/__cart/status.json?reqno=0'
    ...
    def test__api_cart_addrange_multi_download(self):
        ...
        expected = {'total_download_count': 92, 'total_download_size': 10726624, 'total_download_size_pretty': '10M', 'product_cat_list': [['Cassini VIMS-Specific Products', [{'slug_name': 'covims_raw', 'tooltip': 'Raw data files (*.qub) for Cassini VIMS. Observations are in binary format, uncalibrated, and contain raw data numbers from both the VIS and IR detectors. Associated labels (*.lbl) are text files that contain information about the observation, including how to interpret the binary data.', 'product_type': 'Raw cube', 'product_count': 17, 'download_count': 21, 'download_size': 2919003, 'download_size_pretty': '2M', 'default_checked': 1}, {'slug_name': 'covims_thumb', 'tooltip': 'Thumbnail-size (131x69) JPEGs (*.jpeg_small) supplied by the Cassini VIMS team, showing the recorded spectra of both the VIS and IR channels in grey scale. This representation is different from that provided by the PDS Ring-Moon System Node preview images, which attempt to color-code the observations in a way that emphasizes certain important spectral ranges, including wavelengths seen by the human eye.', 'product_type': 'Extra preview (thumbnail)', 'product_count': 17, 'download_count': 9, 'download_size': 17411, 'download_size_pretty': '17K', 'default_checked': 1}, {'slug_name': 'covims_medium', 'tooltip': 'Medium-size (786x414) JPEGs (*.jpeg) supplied by the Cassini VIMS team, showing the recorded spectra of both the VIS and IR channels in grey scale. This representation is different from that provided by the PDS Ring-Moon System Node preview images, which attempt to color-code the observations in a way that emphasizes certain important spectral ranges, including wavelengths seen by the human eye.', 'product_type': 'Extra preview (medium)', 'product_count': 17, 'download_count': 9, 'download_size': 183437, 'download_size_pretty': '179K', 'default_checked': 1}, {'slug_name': 'covims_full', 'tooltip': 'Full-size (131x69) TIFFs (*.tiff) supplied by the Cassini VIMS team, showing the recorded spectra of both the VIS and IR channels in grey scale. This representation is different from that provided by the PDS Ring-Moon System Node preview images, which attempt to color-code the observations in a way that emphasizes certain important spectral ranges, including wavelengths seen by the human eye.', 'product_type': 'Extra preview (full)', 'product_count': 17, 'download_count': 9, 'download_size': 455148, 'download_size_pretty': '444K', 'default_checked': 1}]], ['Metadata Products', [{'slug_name': 'rms_index', 'tooltip': 'Text files created by the Ring-Moon Systems Node that summarize or augment some metadata for all observations in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'RMS Node Augmented Index', 'product_count': 17, 'download_count': 2, 'download_size': 1982857, 'download_size_pretty': '1M', 'default_checked': 0}, {'slug_name': 'inventory', 'tooltip': 'Text files ([volume]_inventory.tab) that list every planet and moon inside the instrument field of view for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Target Body Inventory', 'product_count': 17, 'download_count': 2, 'download_size': 415545, 'download_size_pretty': '405K', 'default_checked': 1}, {'slug_name': 'planet_geometry', 'tooltip': 'Text files ([volume]_[planet]_summary.tab) that list the values of various surface geometry metadata for the central planet for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Planet Geometry Index', 'product_count': 17, 'download_count': 2, 'download_size': 1527684, 'download_size_pretty': '1M', 'default_checked': 1}, {'slug_name': 'ring_geometry', 'tooltip': 'Text files ([volume]_ring_summary.tab) that list the values of various ring plane intercept geometry metadata for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Ring Geometry Index', 'product_count': 17, 'download_count': 2, 'download_size': 2448696, 'download_size_pretty': '2M', 'default_checked': 1}]], ['Browse Products', [{'slug_name': 'browse_thumb', 'tooltip': 'Thumbnail-size (often 100x100) non-linearly stretched preview JPEGs (*_thumb.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (thumbnail)', 'product_count': 17, 'download_count': 9, 'download_size': 82840, 'download_size_pretty': '80K', 'default_checked': 1}, {'slug_name': 'browse_small', 'tooltip': 'Small-size (often 256x256) non-linearly stretched preview JPEGs (*_small.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (small)', 'product_count': 17, 'download_count': 9, 'download_size': 227327, 'download_size_pretty': '221K', 'default_checked': 1}, {'slug_name': 'browse_medium', 'tooltip': 'Medium-size (often 512x512) non-linearly stretched preview JPEGs (*_med.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (medium)', 'product_count': 17, 'download_count': 9, 'download_size': 233338, 'download_size_pretty': '227K', 'default_checked': 1}, {'slug_name': 'browse_full', 'tooltip': 'Full-size non-linearly stretched preview JPEGs (*_full.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are not colored. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (full)', 'product_count': 17, 'download_count': 9, 'download_size': 233338, 'download_size_pretty': '227K', 'default_checked': 1}]]], 'error': False, 'count': 17, 'recycled_count': 0, 'reqno': 1234567}
        self._run_json_equal(url, expected, ignore='tooltip')
        url = '/__cart/status.json?reqno=456'
        expected = {'recycled_count': 0, 'count': 17, 'reqno': 456}
        self._run_json_equal(url, expected)
    ...
    def test__api_cart_recyclebin_reset(self):
        ...
        expected = {'total_download_count': 16329, 'total_download_size': 2369463226, 'total_download_size_pretty': '2G', 'product_cat_list': [['Cassini VIMS-Specific Products', [{'slug_name': 'covims_raw', 'tooltip': 'Raw data files (*.qub) for Cassini VIMS. Observations are in binary format, uncalibrated, and contain raw data numbers from both the VIS and IR detectors. Associated labels (*.lbl) are text files that contain information about the observation, including how to interpret the binary data.', 'product_type': 'Raw cube', 'product_count': 3536, 'download_count': 3615, 'download_size': 1956301454, 'download_size_pretty': '1G', 'default_checked': 1}, {'slug_name': 'covims_packed', 'tooltip': None, 'product_type': 'Packed version of unpacked raw data', 'product_count': 80, 'download_count': 65, 'download_size': 1968965, 'download_size_pretty': '1M', 'default_checked': 1}, {'slug_name': 'covims_thumb', 'tooltip': 'Thumbnail-size (131x69) JPEGs (*.jpeg_small) supplied by the Cassini VIMS team, showing the recorded spectra of both the VIS and IR channels in grey scale. This representation is different from that provided by the PDS Ring-Moon System Node preview images, which attempt to color-code the observations in a way that emphasizes certain important spectral ranges, including wavelengths seen by the human eye.', 'product_type': 'Extra preview (thumbnail)', 'product_count': 3534, 'download_count': 1805, 'download_size': 5080622, 'download_size_pretty': '4M', 'default_checked': 1}, {'slug_name': 'covims_medium', 'tooltip': 'Medium-size (786x414) JPEGs (*.jpeg) supplied by the Cassini VIMS team, showing the recorded spectra of both the VIS and IR channels in grey scale. This representation is different from that provided by the PDS Ring-Moon System Node preview images, which attempt to color-code the observations in a way that emphasizes certain important spectral ranges, including wavelengths seen by the human eye.', 'product_type': 'Extra preview (medium)', 'product_count': 3534, 'download_count': 1805, 'download_size': 53608642, 'download_size_pretty': '51M', 'default_checked': 1}, {'slug_name': 'covims_full', 'tooltip': 'Full-size (131x69) TIFFs (*.tiff) supplied by the Cassini VIMS team, showing the recorded spectra of both the VIS and IR channels in grey scale. This representation is different from that provided by the PDS Ring-Moon System Node preview images, which attempt to color-code the observations in a way that emphasizes certain important spectral ranges, including wavelengths seen by the human eye.', 'product_type': 'Extra preview (full)', 'product_count': 3534, 'download_count': 1805, 'download_size': 91282460, 'download_size_pretty': '87M', 'default_checked': 1}]], ['Metadata Products', [{'slug_name': 'rms_index', 'tooltip': 'Text files created by the Ring-Moon Systems Node that summarize or augment some metadata for all observations in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'RMS Node Augmented Index', 'product_count': 3536, 'download_count': 2, 'download_size': 1982857, 'download_size_pretty': '1M', 'default_checked': 0}, {'slug_name': 'inventory', 'tooltip': 'Text files ([volume]_inventory.tab) that list every planet and moon inside the instrument field of view for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Target Body Inventory', 'product_count': 3536, 'download_count': 2, 'download_size': 415545, 'download_size_pretty': '405K', 'default_checked': 1}, {'slug_name': 'planet_geometry', 'tooltip': 'Text files ([volume]_[planet]_summary.tab) that list the values of various surface geometry metadata for the central planet for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Planet Geometry Index', 'product_count': 3432, 'download_count': 2, 'download_size': 1527684, 'download_size_pretty': '1M', 'default_checked': 1}, {'slug_name': 'moon_geometry', 'tooltip': 'Text files ([volume]_moon_summary.tab) that list the values of various surface geometry metadata for every moon in the field of view for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Moon Geometry Index', 'product_count': 1010, 'download_count': 2, 'download_size': 481067, 'download_size_pretty': '469K', 'default_checked': 1}, {'slug_name': 'ring_geometry', 'tooltip': 'Text files ([volume]_ring_summary.tab) that list the values of various ring plane intercept geometry metadata for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Ring Geometry Index', 'product_count': 3432, 'download_count': 2, 'download_size': 2448696, 'download_size_pretty': '2M', 'default_checked': 1}]], ['Browse Products', [{'slug_name': 'browse_thumb', 'tooltip': 'Thumbnail-size (often 100x100) non-linearly stretched preview JPEGs (*_thumb.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (thumbnail)', 'product_count': 3536, 'download_count': 1806, 'download_size': 15252708, 'download_size_pretty': '14M', 'default_checked': 1}, {'slug_name': 'browse_small', 'tooltip': 'Small-size (often 256x256) non-linearly stretched preview JPEGs (*_small.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (small)', 'product_count': 3536, 'download_count': 1806, 'download_size': 54801512, 'download_size_pretty': '52M', 'default_checked': 1}, {'slug_name': 'browse_medium', 'tooltip': 'Medium-size (often 512x512) non-linearly stretched preview JPEGs (*_med.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (medium)', 'product_count': 3536, 'download_count': 1806, 'download_size': 92155507, 'download_size_pretty': '87M', 'default_checked': 1}, {'slug_name': 'browse_full', 'tooltip': 'Full-size non-linearly stretched preview JPEGs (*_full.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are not colored. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (full)', 'product_count': 3536, 'download_count': 1806, 'download_size': 92155507, 'download_size_pretty': '87M', 'default_checked': 1}]]], 'count': 3536, 'recycled_count': 0, 'reqno': 42}
        self._run_json_equal(url, expected)
        url = '/__cart/status.json?reqno=456'
