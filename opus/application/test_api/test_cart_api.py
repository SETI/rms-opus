...
class ApiCartTests(TestCase, ApiTestHelper):
    ...
    def test__api_cart_reset(self):
        ...
        url = '/opus/__cart/reset.json?reqno=5'
    ...
    def test__api_cart_add_duplicate_too_many_1(self):
        ...
        if settings.TEST_GO_LIVE:
            ...
            expected = {'recycled_count': 0, 'count': 1, 'error': 'Your request to add OPUS ID hst-12003-wfc3-ibcz21ff to the cart failed - there are already too many observations in the cart and recycle bin. The maximum allowed is 1.', 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/status.json?reqno=456'
        expected = {'recycled_count': 0, 'count': 1, 'reqno': 456}
        self._run_json_equal(url, expected)
    ...
    def test__api_cart_add_two_remove_one_download(self):
        ...
        expected = {'total_download_count': 21, 'total_download_size': 13892943, 'total_download_size_pretty': '13M', 'product_cat_list': [['Cassini ISS-Specific Products', [{'slug_name': 'coiss-raw', 'tooltip': 'Raw image files (*.IMG) for Cassini ISS. Images are in VICAR format, uncalibrated, and in units of DN (data number). Associated labels (*.LBL) are text files that contain information about the image. Also included are tlmtab.fmt, which describes the format of the VICAR binary header, and prefix.fmt, which describes the format of the binary prefix at the beginning of each line of imaging data.', 'product_type': 'Raw image', 'product_count': 1, 'download_count': 4, 'download_size': 1104427, 'download_size_pretty': '1M'}, {'slug_name': 'coiss-calib', 'tooltip': 'Calibrated image files (*_CALIB.IMG) for Cassini ISS. Images are in VICAR format and have been calibrated at the Ring-Moon Systems Node using the CISSCAL pipeline. They are in units of I/F. Associated labels (*.LBL) are text files that contain information about the image and its calibration.', 'product_type': 'Calibrated image', 'product_count': 1, 'download_count': 2, 'download_size': 4206293, 'download_size_pretty': '4M'}, {'slug_name': 'coiss-thumb', 'tooltip': 'Thumbnail-size (50x50) non-linearly stretched preview JPEGs (*.jpeg_small) of observations, supplied by the Cassini Imaging team. The previews are not colored and the stretch may be different from the browse images produced by the Ring-Moon Systems Node.', 'product_type': 'Extra preview (thumbnail)', 'product_count': 1, 'download_count': 1, 'download_size': 564, 'download_size_pretty': '564B'}, {'slug_name': 'coiss-medium', 'tooltip': 'Medium-size (256x256) non-linearly stretched preview JPEGs (*.jpeg) of observations, supplied by the Cassini Imaging team. The previews are not colored and the stretch may be different from the browse images produced by the Ring-Moon Systems Node.', 'product_type': 'Extra preview (medium)', 'product_count': 1, 'download_count': 1, 'download_size': 2849, 'download_size_pretty': '2K'}, {'slug_name': 'coiss-full', 'tooltip': 'Full-size non-linearly stretched preview PNGs or TIFFs (*.png or *.tiff) of observations, supplied by the Cassini Imaging team. The previews are not colored and the stretch may be different from the browse images produced by the Ring-Moon Systems Node.', 'product_type': 'Extra preview (full)', 'product_count': 1, 'download_count': 1, 'download_size': 259925, 'download_size_pretty': '253K'}]], ['Metadata Products', [{'slug_name': 'inventory', 'tooltip': 'Text files ([volume]_inventory.tab) that list every planet and moon inside the instrument field of view for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Target Body Inventory', 'product_count': 1, 'download_count': 2, 'download_size': 385596, 'download_size_pretty': '376K'}, {'slug_name': 'planet-geometry', 'tooltip': 'Text files ([volume]_[planet]_summary.tab) that list the values of various surface geometry metadata for the central planet for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Planet Geometry Index', 'product_count': 1, 'download_count': 2, 'download_size': 1364814, 'download_size_pretty': '1M'}, {'slug_name': 'moon-geometry', 'tooltip': 'Text files ([volume]_moon_summary.tab) that list the values of various surface geometry metadata for every moon in the field of view for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Moon Geometry Index', 'product_count': 1, 'download_count': 2, 'download_size': 4111515, 'download_size_pretty': '3M'}, {'slug_name': 'ring-geometry', 'tooltip': 'Text files ([volume]_ring_summary.tab) that list the values of various ring plane intercept geometry metadata for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Ring Geometry Index', 'product_count': 1, 'download_count': 2, 'download_size': 2229982, 'download_size_pretty': '2M'}]], ['Browse Products', [{'slug_name': 'browse-thumb', 'tooltip': 'Thumbnail-size (often 100x100) non-linearly stretched preview JPEGs (*_thumb.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (thumbnail)', 'product_count': 1, 'download_count': 1, 'download_size': 995, 'download_size_pretty': '995B'}, {'slug_name': 'browse-small', 'tooltip': 'Small-size (often 256x256) non-linearly stretched preview JPEGs (*_small.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (small)', 'product_count': 1, 'download_count': 1, 'download_size': 3012, 'download_size_pretty': '2K'}, {'slug_name': 'browse-medium', 'tooltip': 'Medium-size (often 512x512) non-linearly stretched preview JPEGs (*_med.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (medium)', 'product_count': 1, 'download_count': 1, 'download_size': 7892, 'download_size_pretty': '7K'}, {'slug_name': 'browse-full', 'tooltip': 'Full-size non-linearly stretched preview JPEGs (*_full.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are not colored. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (full-size)', 'product_count': 1, 'download_count': 1, 'download_size': 215079, 'download_size_pretty': '210K'}]]], 'error': False, 'count': 1, 'recycled_count': 0, 'reqno': 101010102}
        self._run_json_equal(url, expected, ignore='tooltip')
        url = '/opus/__cart/status.json?reqno=789'
    ...
    def test__api_cart_add_two_remove_one_download_recyclebin1(self):
        ...
        expected = {'total_download_count': 21, 'total_download_size': 13892943, 'total_download_size_pretty': '13M', 'product_cat_list': [['Cassini ISS-Specific Products', [{'slug_name': 'coiss-raw', 'tooltip': 'Raw image files (*.IMG) for Cassini ISS. Images are in VICAR format, uncalibrated, and in units of DN (data number). Associated labels (*.LBL) are text files that contain information about the image. Also included are tlmtab.fmt, which describes the format of the VICAR binary header, and prefix.fmt, which describes the format of the binary prefix at the beginning of each line of imaging data.', 'product_type': 'Raw image', 'product_count': 1, 'download_count': 4, 'download_size': 1104427, 'download_size_pretty': '1M'}, {'slug_name': 'coiss-calib', 'tooltip': 'Calibrated image files (*_CALIB.IMG) for Cassini ISS. Images are in VICAR format and have been calibrated at the Ring-Moon Systems Node using the CISSCAL pipeline. They are in units of I/F. Associated labels (*.LBL) are text files that contain information about the image and its calibration.', 'product_type': 'Calibrated image', 'product_count': 1, 'download_count': 2, 'download_size': 4206293, 'download_size_pretty': '4M'}, {'slug_name': 'coiss-thumb', 'tooltip': 'Thumbnail-size (50x50) non-linearly stretched preview JPEGs (*.jpeg_small) of observations, supplied by the Cassini Imaging team. The previews are not colored and the stretch may be different from the browse images produced by the Ring-Moon Systems Node.', 'product_type': 'Extra preview (thumbnail)', 'product_count': 1, 'download_count': 1, 'download_size': 564, 'download_size_pretty': '564B'}, {'slug_name': 'coiss-medium', 'tooltip': 'Medium-size (256x256) non-linearly stretched preview JPEGs (*.jpeg) of observations, supplied by the Cassini Imaging team. The previews are not colored and the stretch may be different from the browse images produced by the Ring-Moon Systems Node.', 'product_type': 'Extra preview (medium)', 'product_count': 1, 'download_count': 1, 'download_size': 2849, 'download_size_pretty': '2K'}, {'slug_name': 'coiss-full', 'tooltip': 'Full-size non-linearly stretched preview PNGs or TIFFs (*.png or *.tiff) of observations, supplied by the Cassini Imaging team. The previews are not colored and the stretch may be different from the browse images produced by the Ring-Moon Systems Node.', 'product_type': 'Extra preview (full)', 'product_count': 1, 'download_count': 1, 'download_size': 259925, 'download_size_pretty': '253K'}]], ['Metadata Products', [{'slug_name': 'inventory', 'tooltip': 'Text files ([volume]_inventory.tab) that list every planet and moon inside the instrument field of view for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Target Body Inventory', 'product_count': 1, 'download_count': 2, 'download_size': 385596, 'download_size_pretty': '376K'}, {'slug_name': 'planet-geometry', 'tooltip': 'Text files ([volume]_[planet]_summary.tab) that list the values of various surface geometry metadata for the central planet for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Planet Geometry Index', 'product_count': 1, 'download_count': 2, 'download_size': 1364814, 'download_size_pretty': '1M'}, {'slug_name': 'moon-geometry', 'tooltip': 'Text files ([volume]_moon_summary.tab) that list the values of various surface geometry metadata for every moon in the field of view for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Moon Geometry Index', 'product_count': 1, 'download_count': 2, 'download_size': 4111515, 'download_size_pretty': '3M'}, {'slug_name': 'ring-geometry', 'tooltip': 'Text files ([volume]_ring_summary.tab) that list the values of various ring plane intercept geometry metadata for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Ring Geometry Index', 'product_count': 1, 'download_count': 2, 'download_size': 2229982, 'download_size_pretty': '2M'}]], ['Browse Products', [{'slug_name': 'browse-thumb', 'tooltip': 'Thumbnail-size (often 100x100) non-linearly stretched preview JPEGs (*_thumb.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (thumbnail)', 'product_count': 1, 'download_count': 1, 'download_size': 995, 'download_size_pretty': '995B'}, {'slug_name': 'browse-small', 'tooltip': 'Small-size (often 256x256) non-linearly stretched preview JPEGs (*_small.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (small)', 'product_count': 1, 'download_count': 1, 'download_size': 3012, 'download_size_pretty': '2K'}, {'slug_name': 'browse-medium', 'tooltip': 'Medium-size (often 512x512) non-linearly stretched preview JPEGs (*_med.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (medium)', 'product_count': 1, 'download_count': 1, 'download_size': 7892, 'download_size_pretty': '7K'}, {'slug_name': 'browse-full', 'tooltip': 'Full-size non-linearly stretched preview JPEGs (*_full.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are not colored. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (full-size)', 'product_count': 1, 'download_count': 1, 'download_size': 215079, 'download_size_pretty': '210K'}]]], 'error': False, 'count': 1, 'recycled_count': 1, 'reqno': 101010102}
        self._run_json_equal(url, expected, ignore='tooltip')
        url = '/opus/__cart/status.json?reqno=789'
    ...
    def test__api_cart_addrange_multi_recyclebin0(self):
        ...
        expected = {'recycled_count': 0, 'count': 0, 'reqno': 42}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/addrange.json?volumeid=COVIMS_0006&range=co-vims-v1488642557_ir,co-vims-v1488646261_ir&reqno=456&recyclebin=0'
        expected = {'recycled_count': 0, 'count': 17, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/status.json?reqno=456'
        expected = {'recycled_count': 0, 'count': 17, 'reqno': 456}
    ...
    def test__api_cart_addrange_multi_recyclebin1(self):
        ...
        expected = {'recycled_count': 0, 'count': 0, 'reqno': 42}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/addrange.json?volumeid=COVIMS_0006&range=co-vims-v1488642557_ir,co-vims-v1488646261_ir&reqno=456&recyclebin=1'
        expected = {'recycled_count': 0, 'count': 17, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/status.json?reqno=456'
        expected = {'recycled_count': 0, 'count': 17, 'reqno': 456}
    ...
    def test__api_cart_addrange_multi_download(self):
        ...
        expected = {'total_download_count': 92, 'total_download_size': 9224834, 'total_download_size_pretty': '8M', 'product_cat_list': [['Cassini VIMS-Specific Products', [{'slug_name': 'covims-raw', 'tooltip': 'Raw data files (*.qub) for Cassini VIMS. Observations are in binary format, uncalibrated, and contain raw data numbers from both the VIS and IR detectors. Associated labels (*.lbl) are text files that contain information about the observation, including how to interpret the binary data.', 'product_type': 'Raw cube', 'product_count': 17, 'download_count': 21, 'download_size': 2919003, 'download_size_pretty': '2M'}, {'slug_name': 'covims-thumb', 'tooltip': 'Thumbnail-size (131x69) JPEGs (*.jpeg_small) supplied by the Cassini VIMS team, showing the recorded spectra of both the VIS and IR channels in grey scale. This representation is different from that provided by the PDS Ring-Moon System Node preview images, which attempt to color-code the observations in a way that emphasizes certain important spectral ranges, including wavelengths seen by the human eye.', 'product_type': 'Extra preview (thumbnail)', 'product_count': 17, 'download_count': 9, 'download_size': 17411, 'download_size_pretty': '17K'}, {'slug_name': 'covims-medium', 'tooltip': 'Medium-size (786x414) JPEGs (*.jpeg) supplied by the Cassini VIMS team, showing the recorded spectra of both the VIS and IR channels in grey scale. This representation is different from that provided by the PDS Ring-Moon System Node preview images, which attempt to color-code the observations in a way that emphasizes certain important spectral ranges, including wavelengths seen by the human eye.', 'product_type': 'Extra preview (medium)', 'product_count': 17, 'download_count': 9, 'download_size': 183437, 'download_size_pretty': '179K'}, {'slug_name': 'covims-full', 'tooltip': 'Full-size (131x69) TIFFs (*.tiff) supplied by the Cassini VIMS team, showing the recorded spectra of both the VIS and IR channels in grey scale. This representation is different from that provided by the PDS Ring-Moon System Node preview images, which attempt to color-code the observations in a way that emphasizes certain important spectral ranges, including wavelengths seen by the human eye.', 'product_type': 'Extra preview (full)', 'product_count': 17, 'download_count': 9, 'download_size': 455148, 'download_size_pretty': '444K'}]], ['Metadata Products', [{'slug_name': 'inventory', 'tooltip': 'Text files ([volume]_inventory.tab) that list every planet and moon inside the instrument field of view for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Target Body Inventory', 'product_count': 17, 'download_count': 2, 'download_size': 415545, 'download_size_pretty': '405K'}, {'slug_name': 'planet-geometry', 'tooltip': 'Text files ([volume]_[planet]_summary.tab) that list the values of various surface geometry metadata for the central planet for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Planet Geometry Index', 'product_count': 17, 'download_count': 2, 'download_size': 1527684, 'download_size_pretty': '1M'}, {'slug_name': 'moon-geometry', 'tooltip': 'Text files ([volume]_moon_summary.tab) that list the values of various surface geometry metadata for every moon in the field of view for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Moon Geometry Index', 'product_count': 17, 'download_count': 2, 'download_size': 481067, 'download_size_pretty': '469K'}, {'slug_name': 'ring-geometry', 'tooltip': 'Text files ([volume]_ring_summary.tab) that list the values of various ring plane intercept geometry metadata for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Ring Geometry Index', 'product_count': 17, 'download_count': 2, 'download_size': 2448696, 'download_size_pretty': '2M'}]], ['Browse Products', [{'slug_name': 'browse-thumb', 'tooltip': 'Thumbnail-size (often 100x100) non-linearly stretched preview JPEGs (*_thumb.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (thumbnail)', 'product_count': 17, 'download_count': 9, 'download_size': 82840, 'download_size_pretty': '80K'}, {'slug_name': 'browse-small', 'tooltip': 'Small-size (often 256x256) non-linearly stretched preview JPEGs (*_small.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (small)', 'product_count': 17, 'download_count': 9, 'download_size': 227327, 'download_size_pretty': '221K'}, {'slug_name': 'browse-medium', 'tooltip': 'Medium-size (often 512x512) non-linearly stretched preview JPEGs (*_med.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (medium)', 'product_count': 17, 'download_count': 9, 'download_size': 233338, 'download_size_pretty': '227K'}, {'slug_name': 'browse-full', 'tooltip': 'Full-size non-linearly stretched preview JPEGs (*_full.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are not colored. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (full-size)', 'product_count': 17, 'download_count': 9, 'download_size': 233338, 'download_size_pretty': '227K'}]]], 'error': False, 'count': 17, 'recycled_count': 0, 'reqno': 1234567}
        self._run_json_equal(url, expected, ignore='tooltip')
        url = '/opus/__cart/status.json?reqno=456'
        expected = {'recycled_count': 0, 'count': 17, 'reqno': 456}
        self._run_json_equal(url, expected)
    ...
    def test__api_cart_removerange_add_one_recyclebin0(self):
        ...
        expected = {'recycled_count': 0, 'count': 1, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/removerange.json?volumeid=COVIMS_0006&range=co-vims-v1484504505_ir,co-vims-v1484504505_ir&reqno=456&recyclebin=0'
        expected = {'recycled_count': 0, 'count': 0, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/status.json?reqno=456'
        expected = {'recycled_count': 0, 'count': 0, 'reqno': 456}
    ...
    def test__api_cart_removerange_add_one_recyclebin1(self):
        ...
        expected = {'recycled_count': 0, 'count': 1, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/removerange.json?volumeid=COVIMS_0006&range=co-vims-v1484504505_ir,co-vims-v1484504505_ir&reqno=456&recyclebin=1'
        expected = {'recycled_count': 1, 'count': 0, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/status.json?reqno=456'
        expected = {'recycled_count': 1, 'count': 0, 'reqno': 456}
    ...
    def test__api_cart_removerange_duplicate_recyclebin1(self):
        ...
        expected = {'recycled_count': 0, 'count': 1, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/removerange.json?volumeid=COVIMS_0006&range=co-vims-v1484528864_ir,co-vims-v1484528864_ir&reqno=456&recyclebin=1'
        expected = {'recycled_count': 1, 'count': 0, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/removerange.json?volumeid=COVIMS_0006&range=co-vims-v1484528864_ir,co-vims-v1484528864_ir&reqno=456&recyclebin=1'
        expected = {'recycled_count': 1, 'count': 0, 'error': False, 'reqno': 456}
    ...
    def test__api_cart_addrange_bad_range1_cart(self):
        ...
        expected = {'recycled_count': 0, 'count': 0, 'reqno': 42}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/addrange.json?view=cart&range=co-vims-v1484504505_ir&reqno=456'
        self._run_status_equal(url, 404, settings.HTTP404_BAD_OR_MISSING_RANGE)
        url = '/opus/__cart/status.json?reqno=456'
        expected = {'recycled_count': 0, 'count': 0, 'reqno': 456}
        self._run_json_equal(url, expected)
    ...
    def test__api_cart_addrange_bad_range4_cart(self):
        ...
        expected = {'recycled_count': 0, 'count': 0, 'reqno': 42}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/addrange.json?view=cart&range=co-vims-v1484504505_ir,co-vims-v1484504505_ir,co-vims-v1484504505_ir&reqno=456'
        self._run_status_equal(url, 404, settings.HTTP404_BAD_OR_MISSING_RANGE)
        url = '/opus/__cart/status.json?reqno=456'
        expected = {'recycled_count': 0, 'count': 0, 'reqno': 456}
        self._run_json_equal(url, expected)
    ...
    def test__api_cart_addrange_duplicate_cart(self):
        ...
        expected = {'recycled_count': 0, 'count': 1, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/addrange.json?view=cart&range=co-vims-v1484504505_ir,co-vims-v1484504505_ir&reqno=456'
        expected = {'recycled_count': 0, 'count': 1, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/status.json?reqno=456'
        expected = {'recycled_count': 0, 'count': 1, 'reqno': 456}
    ...
    def test__api_cart_addrange_duplicate_cart_recyclebin0(self):
        ...
        expected = {'recycled_count': 0, 'count': 1, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/addrange.json?view=cart&range=co-vims-v1484504505_ir,co-vims-v1484504505_ir&reqno=456&recyclebin=0'
        expected = {'recycled_count': 0, 'count': 1, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/status.json?reqno=456'
        expected = {'recycled_count': 0, 'count': 1, 'reqno': 456}
    ...
    def test__api_cart_addrange_duplicate_cart_recyclebin1(self):
        ...
        expected = {'recycled_count': 0, 'count': 1, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/addrange.json?view=cart&range=co-vims-v1484504505_ir,co-vims-v1484504505_ir&reqno=456&recyclebin=1'
        expected = {'recycled_count': 0, 'count': 1, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/status.json?reqno=456'
        expected = {'recycled_count': 0, 'count': 1, 'reqno': 456}
    ...
    def test__api_cart_addrange_bad_opusid_cart(self):
        ...
        expected = {'recycled_count': 0, 'count': 1, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/addrange.json?view=cart&range=co-vims-v1484528864_irx,co-vims-v1484528864_ir&reqno=456'
    ...
    def test__api_cart_addrange_multi_not_cart_cart(self):
        ...
        expected = {'recycled_count': 0, 'count': 0, 'reqno': 42}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/addrange.json?volumeid=COVIMS_0006&range=co-vims-v1484506475_ir,co-vims-v1484507574_vis&reqno=456'
        expected = {'recycled_count': 0, 'count': 6, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/addrange.json?view=cart&volumeid=COVIMS_0006&range=co-vims-v1484504505_vis,co-vims-v1484507574_vis&reqno=456'
    ...
    def test__api_cart_addrange_duplicate2_too_many_17_cart(self):
        ...
        expected = {'recycled_count': 0, 'count': 17, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/addrange.json?view=cart&range=co-vims-v1488642557_ir,co-vims-v1488646261_ir&reqno=456'
        expected = {'recycled_count': 0, 'count': 17, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/status.json?reqno=456'
        expected = {'recycled_count': 0, 'count': 17, 'reqno': 456}
    ...
    def test__api_cart_removerange_add_one_cart_recyclebin1(self):
        ...
        expected = {'recycled_count': 0, 'count': 1, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/removerange.json?view=cart&volumeid=COVIMS_0006&range=co-vims-v1484504505_ir,co-vims-v1484504505_ir&reqno=456&recyclebin=1'
        expected = {'recycled_count': 1, 'count': 0, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/status.json?reqno=456'
        expected = {'recycled_count': 1, 'count': 0, 'reqno': 456}
    ...
    def test__api_cart_removerange_duplicate_cart_recyclebin1(self):
        ...
        expected = {'recycled_count': 0, 'count': 1, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/removerange.json?view=cart&volumeid=COVIMS_0006&range=co-vims-v1484528864_ir,co-vims-v1484528864_ir&reqno=456&recyclebin=1'
        expected = {'recycled_count': 1, 'count': 0, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/removerange.json?view=cart&volumeid=COVIMS_0006&range=co-vims-v1484528864_ir,co-vims-v1484528864_ir&reqno=456&recyclebin=1'
        expected = {'recycled_count': 1, 'count': 0, 'error': False, 'reqno': 456}
    ...
    def test__api_cart_removerange_multi_cart_recyclebin1(self):
        ...
        expected = {'recycled_count': 0, 'count': 17, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/removerange.json?view=cart&range=co-vims-v1488642979_vis,co-vims-v1488644245_vis&reqno=456&recyclebin=1'
    ...
    def test__api_cart_removerange_multi_reverse_cart_recyclebin1(self):
        ...
        expected = {'recycled_count': 0, 'count': 17, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/removerange.json?view=cart&range=co-vims-v1488644245_vis,co-vims-v1488642979_vis&reqno=456&recyclebin=1'
        expected = {'recycled_count': 7, 'count': 10, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/status.json?reqno=456'
        expected = {'recycled_count': 7, 'count': 10, 'reqno': 456}
    ...
    def test__api_cart_addall_one_download(self):
        ...
        expected = {'total_download_count': 620, 'total_download_size': 169444386, 'total_download_size_pretty': '161M', 'product_cat_list': [['Voyager ISS-Specific Products', [{'slug_name': 'vgiss-raw', 'tooltip': 'Raw image files (*_RAW.IMG) for Voyager ISS. Images are in VICAR format, uncalibrated, and in units of DN (data number). Associated labels (*.LBL) are text files that contain information about the image. Raw images have not been geometrically corrected and contain significant distortions.', 'product_type': 'Raw Image', 'product_count': 34, 'download_count': 68, 'download_size': 28148748, 'download_size_pretty': '26M'}, {'slug_name': 'vgiss-cleaned', 'tooltip': 'Cleaned image files (*_CLEANED.IMG) for Voyager ISS. Images are in VICAR format, uncalibrated, and in units of DN (data number). Associated labels (*.LBL) are text files that contain information about the image. Apparent flaws in the raw image, including reseau markings and spikes, have been removed.', 'product_type': 'Cleaned Image', 'product_count': 34, 'download_count': 68, 'download_size': 21936280, 'download_size_pretty': '20M'}, {'slug_name': 'vgiss-calib', 'tooltip': 'Calibrated image files (*_CALIB.IMG) for Voyager ISS. Images are in VICAR format and have been calibrated at the Ring-Moon Systems Node using the VICAR software package. They are in units of scaled I/F. Associated labels (*.LBL) are text files that contain information about the image. Calibration was performed after apparent flaws in the raw image, including reseau markings and spikes, were removed; these are calibrated versions of the cleaned images (*_CLEANED.IMG).', 'product_type': 'Calibrated Image', 'product_count': 34, 'download_count': 68, 'download_size': 43769972, 'download_size_pretty': '41M'}, {'slug_name': 'vgiss-geomed', 'tooltip': 'Calibrated and geometrically corrected image files (*_GEOMED.IMG) for Voyager ISS. Images are in VICAR format and have been calibrated and geometrically corrected at the Ring-Moon Systems Node using the VICAR software package. They are in units of scaled I/F. Associated labels (*.LBL) are text files that contain information about the image. Calibration was performed after apparent flaws in the raw image, including reseau markings and spikes, were removed; these are geometrically corrected versions of the calibrated images (*_CALIB.IMG).', 'product_type': 'Geometrically Corrected Image', 'product_count': 34, 'download_count': 68, 'download_size': 68190894, 'download_size_pretty': '65M'}, {'slug_name': 'vgiss-resloc', 'tooltip': 'Files describing the determined location of the reseau markings for an image. Locations are provided in VICAR format (*_RESLOC.DAT) and text format (*_RESLOC.TAB). An associated label (*_RESLOC.LBL) is a text file that contains information about the *.DAT and *.TAB files.', 'product_type': 'Reseau Table', 'product_count': 34, 'download_count': 102, 'download_size': 672296, 'download_size_pretty': '656K'}, {'slug_name': 'vgiss-geoma', 'tooltip': 'Files describing the nominal and measured reseau mark locations used to geometrically correct the image. Locations are provided in VICAR format (*_GEOMA.DAT) and text format (*_GEOMA.TAB). An associated label (*_GEOMA.LBL) is a text file that contains information about the *.DAT and *.TAB files.', 'product_type': 'Geometric Tiepoint Table', 'product_count': 34, 'download_count': 102, 'download_size': 1424003, 'download_size_pretty': '1M'}]], ['Metadata Products', [{'slug_name': 'inventory', 'tooltip': 'Text files ([volume]_inventory.tab) that list every planet and moon inside the instrument field of view for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Target Body Inventory', 'product_count': 34, 'download_count': 2, 'download_size': 93792, 'download_size_pretty': '91K'}, {'slug_name': 'planet-geometry', 'tooltip': 'Text files ([volume]_[planet]_summary.tab) that list the values of various surface geometry metadata for the central planet for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Planet Geometry Index', 'product_count': 34, 'download_count': 2, 'download_size': 307087, 'download_size_pretty': '299K'}, {'slug_name': 'moon-geometry', 'tooltip': 'Text files ([volume]_moon_summary.tab) that list the values of various surface geometry metadata for every moon in the field of view for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Moon Geometry Index', 'product_count': 34, 'download_count': 2, 'download_size': 1775739, 'download_size_pretty': '1M'}, {'slug_name': 'ring-geometry', 'tooltip': 'Text files ([volume]_ring_summary.tab) that list the values of various ring plane intercept geometry metadata for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Ring Geometry Index', 'product_count': 34, 'download_count': 2, 'download_size': 509807, 'download_size_pretty': '497K'}]], ['Browse Products', [{'slug_name': 'browse-thumb', 'tooltip': 'Thumbnail-size (often 100x100) non-linearly stretched preview JPEGs (*_thumb.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (thumbnail)', 'product_count': 34, 'download_count': 34, 'download_size': 49298, 'download_size_pretty': '48K'}, {'slug_name': 'browse-small', 'tooltip': 'Small-size (often 256x256) non-linearly stretched preview JPEGs (*_small.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (small)', 'product_count': 34, 'download_count': 34, 'download_size': 117246, 'download_size_pretty': '114K'}, {'slug_name': 'browse-medium', 'tooltip': 'Medium-size (often 512x512) non-linearly stretched preview JPEGs (*_med.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (medium)', 'product_count': 34, 'download_count': 34, 'download_size': 428816, 'download_size_pretty': '418K'}, {'slug_name': 'browse-full', 'tooltip': 'Full-size non-linearly stretched preview JPEGs (*_full.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are not colored. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (full-size)', 'product_count': 34, 'download_count': 34, 'download_size': 2020408, 'download_size_pretty': '1M'}]]], 'error': False, 'count': 34, 'recycled_count': 0, 'reqno': 9878}
        self._run_json_equal(url, expected, ignore='tooltip')
        url = '/opus/__cart/status.json?reqno=456'
    ...
    def test__api_cart_add_remove_recyclebin(self):
        ...
        expected = {'recycled_count': 0, 'count': 3544, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/removerange.json?volumeid=COVIMS_0006&range=co-vims-v1484504505_vis,co-vims-v1484506475_vis&reqno=456'
        expected = {'recycled_count': 0, 'count': 3539, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/removerange.json?view=cart&range=co-vims-v1484506705_vis,co-vims-v1484507800_ir&reqno=456&recyclebin=0'
        expected = {'recycled_count': 0, 'count': 3535, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/removerange.json?view=cart&range=co-vims-v1484509868_ir,co-vims-v1484510890_vis&reqno=456&recyclebin=1'
        expected = {'recycled_count': 8, 'count': 3527, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/addrange.json?view=cart&range=co-vims-v1484509868_vis,co-vims-v1484510044_ir&reqno=456'
        expected = {'recycled_count': 6, 'count': 3529, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/addrange.json?view=browse&range=co-vims-v1484510714_ir,co-vims-v1484510890_ir&reqno=456'
    ...
    def test__api_cart_recyclebin_reset(self):
        ...
        self._run_json_equal(url, expected)
        url = '/opus/__cart/reset.json?reqno=42&recyclebin=1'
        ...
        expected = {'recycled_count': 8, 'count': 3536, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/reset.json?reqno=42&recyclebin=1&download=1'
        expected = {'total_download_count': 16327, 'total_download_size': 2367480369, 'total_download_size_pretty': '2G', 'product_cat_list': [['Cassini VIMS-Specific Products', [{'slug_name': 'covims-raw', 'tooltip': 'Raw data files (*.qub) for Cassini VIMS. Observations are in binary format, uncalibrated, and contain raw data numbers from both the VIS and IR detectors. Associated labels (*.lbl) are text files that contain information about the observation, including how to interpret the binary data.', 'product_type': 'Raw cube', 'product_count': 3536, 'download_count': 3615, 'download_size': 1956301454, 'download_size_pretty': '1G'}, {'slug_name': 'covims-packed', 'tooltip': None, 'product_type': 'Packed version of unpacked raw data', 'product_count': 80, 'download_count': 65, 'download_size': 1968965, 'download_size_pretty': '1M'}, {'slug_name': 'covims-thumb', 'tooltip': 'Thumbnail-size (131x69) JPEGs (*.jpeg_small) supplied by the Cassini VIMS team, showing the recorded spectra of both the VIS and IR channels in grey scale. This representation is different from that provided by the PDS Ring-Moon System Node preview images, which attempt to color-code the observations in a way that emphasizes certain important spectral ranges, including wavelengths seen by the human eye.', 'product_type': 'Extra preview (thumbnail)', 'product_count': 3534, 'download_count': 1805, 'download_size': 5080622, 'download_size_pretty': '4M'}, {'slug_name': 'covims-medium', 'tooltip': 'Medium-size (786x414) JPEGs (*.jpeg) supplied by the Cassini VIMS team, showing the recorded spectra of both the VIS and IR channels in grey scale. This representation is different from that provided by the PDS Ring-Moon System Node preview images, which attempt to color-code the observations in a way that emphasizes certain important spectral ranges, including wavelengths seen by the human eye.', 'product_type': 'Extra preview (medium)', 'product_count': 3534, 'download_count': 1805, 'download_size': 53608642, 'download_size_pretty': '51M'}, {'slug_name': 'covims-full', 'tooltip': 'Full-size (131x69) TIFFs (*.tiff) supplied by the Cassini VIMS team, showing the recorded spectra of both the VIS and IR channels in grey scale. This representation is different from that provided by the PDS Ring-Moon System Node preview images, which attempt to color-code the observations in a way that emphasizes certain important spectral ranges, including wavelengths seen by the human eye.', 'product_type': 'Extra preview (full)', 'product_count': 3534, 'download_count': 1805, 'download_size': 91282460, 'download_size_pretty': '87M'}]], ['Metadata Products', [{'slug_name': 'inventory', 'tooltip': 'Text files ([volume]_inventory.tab) that list every planet and moon inside the instrument field of view for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Target Body Inventory', 'product_count': 3536, 'download_count': 2, 'download_size': 415545, 'download_size_pretty': '405K'}, {'slug_name': 'planet-geometry', 'tooltip': 'Text files ([volume]_[planet]_summary.tab) that list the values of various surface geometry metadata for the central planet for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Planet Geometry Index', 'product_count': 3536, 'download_count': 2, 'download_size': 1527684, 'download_size_pretty': '1M'}, {'slug_name': 'moon-geometry', 'tooltip': 'Text files ([volume]_moon_summary.tab) that list the values of various surface geometry metadata for every moon in the field of view for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Moon Geometry Index', 'product_count': 3536, 'download_count': 2, 'download_size': 481067, 'download_size_pretty': '469K'}, {'slug_name': 'ring-geometry', 'tooltip': 'Text files ([volume]_ring_summary.tab) that list the values of various ring plane intercept geometry metadata for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.', 'product_type': 'Ring Geometry Index', 'product_count': 3536, 'download_count': 2, 'download_size': 2448696, 'download_size_pretty': '2M'}]], ['Browse Products', [{'slug_name': 'browse-thumb', 'tooltip': 'Thumbnail-size (often 100x100) non-linearly stretched preview JPEGs (*_thumb.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (thumbnail)', 'product_count': 3536, 'download_count': 1806, 'download_size': 15252708, 'download_size_pretty': '14M'}, {'slug_name': 'browse-small', 'tooltip': 'Small-size (often 256x256) non-linearly stretched preview JPEGs (*_small.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (small)', 'product_count': 3536, 'download_count': 1806, 'download_size': 54801512, 'download_size_pretty': '52M'}, {'slug_name': 'browse-medium', 'tooltip': 'Medium-size (often 512x512) non-linearly stretched preview JPEGs (*_med.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (medium)', 'product_count': 3536, 'download_count': 1806, 'download_size': 92155507, 'download_size_pretty': '87M'}, {'slug_name': 'browse-full', 'tooltip': 'Full-size non-linearly stretched preview JPEGs (*_full.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are not colored. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.', 'product_type': 'Browse Image (full-size)', 'product_count': 3536, 'download_count': 1806, 'download_size': 92155507, 'download_size_pretty': '87M'}]]], 'count': 3536, 'recycled_count': 0, 'reqno': 42}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/status.json?reqno=456'
        expected = {'recycled_count': 0, 'count': 3536, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/reset.json?reqno=42&recyclebin=0'
        expected = {'recycled_count': 0, 'count': 0, 'reqno': 42}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/status.json?reqno=456'
        expected = {'recycled_count': 0, 'count': 0, 'reqno': 456}
    ...
    def test__api_cart_addall_recyclebin(self):
        ...
        self._run_json_equal(url, expected)
        url = '/opus/__cart/addall.json?view=cart&reqno=456' # Does nothing
        expected = {'recycled_count': 8, 'count': 3531, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/addall.json?view=cart&reqno=456&recyclebin=1'
        expected = {'recycled_count': 0, 'count': 3539, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/addall.json?view=cart&reqno=456&recyclebin=1'
        expected = {'recycled_count': 0, 'count': 3539, 'error': False, 'reqno': 456}
    ...
    def test__api_cart_add_too_many_2_recyclebin(self):
        ...
        url = '/opus/__cart/add.json?opusid=co-vims-v1484509868_ir&reqno=456'
        expected = {'recycled_count': 0, 'count': 2, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        # Cart: vg-iss-2-s-c4360018, co-vims-v1484509868_ir
        url = '/opus/__cart/add.json?opusid=co-vims-v1484510890_vis&reqno=456'
        if settings.TEST_GO_LIVE:
            expected = {'recycled_count': 0, 'count': 3, 'error': False, 'reqno': 456}
        else:
        ...
        self._run_json_equal(url, expected)
        url = '/opus/__cart/remove.json?opusid=co-vims-v1484509868_ir&recyclebin=1&reqno=456'
        if settings.TEST_GO_LIVE:
            expected = {'recycled_count': 1, 'count': 2, 'error': False, 'reqno': 456}
        else:
            expected = {'recycled_count': 1, 'count': 1, 'error': False, 'reqno': 456}
    ...
    def test__api_cart_addrange_too_many_17_recyclebin(self):
        ...
        expected = {'recycled_count': 0, 'count': 17, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/removerange.json?range=co-vims-v1488642557_ir,co-vims-v1488642557_ir&reqno=456&recyclebin=1'
        expected = {'recycled_count': 1, 'count': 16, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/addrange.json?range=vg-iss-2-s-c4360018,vg-iss-2-s-c4360018&reqno=456'
        if settings.TEST_GO_LIVE:
        ...
        self._run_json_equal(url, expected)
        url = '/opus/__cart/remove.json?opusid=co-vims-v1488642557_ir&reqno=456&recyclebin=0'
        if settings.TEST_GO_LIVE:
            expected = {'recycled_count': 0, 'count': 17, 'error': False, 'reqno': 456}
        else:
    ...
    def test__api_cart_addall_too_many_906_recyclebin_2(self):
        ...
        expected = {'recycled_count': 0, 'count': 1, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/remove.json?opusid=co-vims-v1488642557_ir&reqno=456&recyclebin=1'
        expected = {'recycled_count': 1, 'count': 0, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/addall.json?volumeid=VGISS_6210&reqno=456'
        if settings.TEST_GO_LIVE:
    ...
    def test__api_cart_addall_too_many_906_recyclebin(self):
        ...
        expected = {'recycled_count': 0, 'count': 906, 'error': False, 'reqno': 456}
        self._run_json_equal(url, expected)
        url = '/opus/__cart/remove.json?opusid=vg-iss-2-s-c4360018&reqno=456&recyclebin=1'
