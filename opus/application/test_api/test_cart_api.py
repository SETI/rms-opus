...
class ApiCartTests(TestCase, ApiTestHelper):
    ...
    def test__api_cart_recyclebin_reset(self):
        ...
        expected = {"total_download_count": 15904, "total_download_size": 2353811199, "total_download_size_pretty": "2G", "product_cat_list": [["Cassini VIMS-Specific Products", [{"slug_name": "covims_raw", "tooltip": "Raw data files (*.qub) for Cassini VIMS. Observations are in binary format, uncalibrated, and contain raw data numbers from both the VIS and IR detectors. Associated labels (*.lbl) are text files that contain information about the observation, including how to interpret the binary data.", "product_type": "Raw cube", "product_count": 3500, "download_count": 3499, "download_size": 1945878817, "download_size_pretty": "1G", "default_checked": 1}, {"slug_name": "covims_thumb", "tooltip": "Thumbnail-size (131x69) JPEGs (*.jpeg_small) supplied by the Cassini VIMS team, showing the recorded spectra of both the VIS and IR channels in grey scale. This representation is different from that provided by the PDS Ring-Moon System Node preview images, which attempt to color-code the observations in a way that emphasizes certain important spectral ranges, including wavelengths seen by the human eye.", "product_type": "Extra preview (thumbnail)", "product_count": 3498, "download_count": 1747, "download_size": 4995693, "download_size_pretty": "4M", "default_checked": 0}, {"slug_name": "covims_medium", "tooltip": "Medium-size (786x414) JPEGs (*.jpeg) supplied by the Cassini VIMS team, showing the recorded spectra of both the VIS and IR channels in grey scale. This representation is different from that provided by the PDS Ring-Moon System Node preview images, which attempt to color-code the observations in a way that emphasizes certain important spectral ranges, including wavelengths seen by the human eye.", "product_type": "Extra preview (medium)", "product_count": 3498, "download_count": 1747, "download_size": 52705367, "download_size_pretty": "50M", "default_checked": 0}, {"slug_name": "covims_full", "tooltip": "Full-size (131x69) TIFFs (*.tiff) supplied by the Cassini VIMS team, showing the recorded spectra of both the VIS and IR channels in grey scale. This representation is different from that provided by the PDS Ring-Moon System Node preview images, which attempt to color-code the observations in a way that emphasizes certain important spectral ranges, including wavelengths seen by the human eye.", "product_type": "Extra preview (full)", "product_count": 3498, "download_count": 1747, "download_size": 88349284, "download_size_pretty": "84M", "default_checked": 1}]], ["Metadata Products", [{"slug_name": "rms_index", "tooltip": "Text files created by the Ring-Moon Systems Node that summarize or augment some metadata for all observations in a particular volume. Associated labels (*.lbl) describe the contents of the text files.", "product_type": "RMS Node Augmented Index", "product_count": 3536, "download_count": 2, "download_size": 1982857, "download_size_pretty": "1M", "default_checked": 0}, {"slug_name": "supplemental_index", "tooltip": "Text files ([volume]_supplemental_index.tab) created by the Ring-Moon Systems Node that augment metadata for all observations in a particular volume. Associated labels (*.lbl) describe the contents of the text files.", "product_type": "Supplemental Index", "product_count": 3536, "download_count": 2, "download_size": 1808328, "download_size_pretty": "1M", "default_checked": 0}, {"slug_name": "inventory", "tooltip": "Text files ([volume]_inventory.csv) that list every planet and moon inside the instrument field of view for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.", "product_type": "Target Body Inventory", "product_count": 3536, "download_count": 2, "download_size": 388396, "download_size_pretty": "379K", "default_checked": 0}, {"slug_name": "planet_geometry", "tooltip": "Text files ([volume]_[planet]_summary.tab) that list the values of various surface geometry metadata for the central planet for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.", "product_type": "Planet Geometry Index", "product_count": 3432, "download_count": 2, "download_size": 1504643, "download_size_pretty": "1M", "default_checked": 0}, {"slug_name": "moon_geometry", "tooltip": "Text files ([volume]_moon_summary.tab) that list the values of various surface geometry metadata for every moon in the field of view for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.", "product_type": "Moon Geometry Index", "product_count": 1010, "download_count": 2, "download_size": 458874, "download_size_pretty": "448K", "default_checked": 0}, {"slug_name": "ring_geometry", "tooltip": "Text files ([volume]_ring_summary.tab) that list the values of various ring plane intercept geometry metadata for every observation in a particular volume. Associated labels (*.lbl) describe the contents of the text files.", "product_type": "Ring Geometry Index", "product_count": 3432, "download_count": 2, "download_size": 2412011, "download_size_pretty": "2M", "default_checked": 0}]], ["Browse Products", [{"slug_name": "browse_thumb", "tooltip": "Thumbnail-size (often 100x100) non-linearly stretched preview JPEGs (*_thumb.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.", "product_type": "Browse Image (thumbnail)", "product_count": 3536, "download_count": 1788, "download_size": 15176325, "download_size_pretty": "14M", "default_checked": 0}, {"slug_name": "browse_small", "tooltip": "Small-size (often 256x256) non-linearly stretched preview JPEGs (*_small.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.", "product_type": "Browse Image (small)", "product_count": 3536, "download_count": 1788, "download_size": 54616716, "download_size_pretty": "52M", "default_checked": 0}, {"slug_name": "browse_medium", "tooltip": "Medium-size (often 512x512) non-linearly stretched preview JPEGs (*_med.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are colored according to the filter used. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.", "product_type": "Browse Image (medium)", "product_count": 3536, "download_count": 1788, "download_size": 91766944, "download_size_pretty": "87M", "default_checked": 0}, {"slug_name": "browse_full", "tooltip": "Full-size non-linearly stretched preview JPEGs (*_full.jpg) of observations created by the Ring-Moon Systems Node. Previews of images are not colored. Previews from non-imaging instruments attempt to represent the contents of observations in a visual way. Previews are not appropriate for scientific use.", "product_type": "Browse Image (full)", "product_count": 3536, "download_count": 1788, "download_size": 91766944, "download_size_pretty": "87M", "default_checked": 1}]]], "count": 3536, "recycled_count": 0, "reqno": 42}
        self._run_json_equal(url, expected)
        url = '/__cart/status.json?reqno=456'
