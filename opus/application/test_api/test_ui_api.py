...
class ApiUITests(TestCase, ApiTestHelper):
    ...
    def test__api_normalizeurl_lonely_qtype_used_any(self):
        "/__normalizeurl: lonely qtype used any"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_lonely_qtype_used_any_bad(self):
        "/__normalizeurl: lonely qtype used any bad"
    ...
    def test__api_normalizeurl_lonely_qtype_used_all(self):
        "/__normalizeurl: lonely qtype used all"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_lonely_qtype_used_only(self):
        "/__normalizeurl: lonely qtype used only"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_lonely_qtype_used_badval_XXX(self):
        "/__normalizeurl: lonely qtype used badval XXX"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_lonely_qtype_used_badval_contains(self):
        "/__normalizeurl: lonely qtype used badval contains"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_lonely_qtype_used_contains(self):
        "/__normalizeurl: lonely qtype used contains"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_lonely_qtype_used_matches(self):
        "/__normalizeurl: lonely qtype used matches"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_lonely_qtype_used_excludes(self):
        "/__normalizeurl: lonely qtype used excludes"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_lonely_qtype_used_begins(self):
        "/__normalizeurl: lonely qtype used begins"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_lonely_qtype_used_ends(self):
        "/__normalizeurl: lonely qtype used ends"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_lonely_qtype_used_badval_any(self):
        "/__normalizeurl: lonely qtype used badval any"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_widgets_empty_1(self):
        "/__normalizeurl: widgets ,instrument"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_widgets_default(self):
        "/__normalizeurl: widgets default"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_widgets_instrumentid(self):
        "/__normalizeurl: widgets instrumentid"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_widgets_instrument_instrument(self):
        "/__normalizeurl: widgets instrument,instrument"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_widgets_instrument_instrumentid(self):
        "/__normalizeurl: widgets instrument,instrumentid"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_widgets_instrumentid_instrument(self):
        "/__normalizeurl: widgets instrumentid,instrument"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_widgets_instrumentid_instrumentid(self):
        "/__normalizeurl: widgets instrumentid,instrumentid"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_widgets_productid(self):
        "/__normalizeurl: widgets productid"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_widgets_ringobsid(self):
        "/__normalizeurl: widgets ringobsid"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_widgets_searched_1(self):
        "/__normalizeurl: widgets searched not widget 1"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_widgets_searched_2(self):
        "/__normalizeurl: widgets searched not widget 2"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_widgets_searched_3(self):
        "/__normalizeurl: widgets searched not widget 3"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_widgets_searched_4(self):
        "/__normalizeurl: widgets searched not widget 4"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_widgets_searched_5(self):
        "/__normalizeurl: widgets searched not widget 5"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_widgets_searched_6(self):
        "/__normalizeurl: widgets searched not widget 6"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_widgets_observationduration(self):
        "/__normalizeurl: widgets observationduration"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_widgets_observationduration1(self):
        "/__normalizeurl: widgets observationduration1"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_widgets_rightasc(self):
        "/__normalizeurl: widgets rightasc"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_widgets_rightasc1(self):
        "/__normalizeurl: widgets rightasc1"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_cols_empty_1(self):
        "/__normalizeurl: cols ,instrument"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_cols_instrumentid(self):
        "/__normalizeurl: cols instrumentid"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_cols_instrument_instrument(self):
        "/__normalizeurl: cols instrument,instrument"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_cols_instrument_instrumentid(self):
        "/__normalizeurl: cols instrument,instrumentid"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_cols_instrumentid_instrument(self):
        "/__normalizeurl: cols instrumentid,instrument"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_cols_instrumentid_instrumentid(self):
        "/__normalizeurl: cols instrumentid,instrumentid"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_cols_not_viewable(self):
        "/__normalizeurl: cols not viewable"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_cols_observationduration(self):
        "/__normalizeurl: cols observationduration"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_cols_observationduration1(self):
        "/__normalizeurl: cols observationduration1"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_order_empty_1(self):
        "/__normalizeurl: order ,instrument"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_order_default_2(self):
        "/__normalizeurl: order default 2"
        new_slugs = dict(self.default_url_slugs)
        url = '/opus/__normalizeurl.json?order=-time1'
    ...
    def test__api_normalizeurl_order_instrumentid(self):
        "/__normalizeurl: order instrumentid"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_order_instrument_instrument(self):
        "/__normalizeurl: order instrument,instrument"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_order_instrument_instrumentid(self):
        "/__normalizeurl: order instrument,instrumentid"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_order_instrumentid_instrument(self):
        "/__normalizeurl: order instrumentid,instrument"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_order_instrumentid_instrument_2(self):
        "/__normalizeurl: order instrumentid,instrument 2"
        new_slugs = dict(self.default_url_slugs)
        url = '/opus/__normalizeurl.json?order=instrumentid,-instrument'
        new_slugs['order'] = 'instrument'
        self._run_url_slugs_equal(url, new_slugs)
    ...
    def test__api_normalizeurl_order_instrumentid_instrument_3(self):
        "/__normalizeurl: order instrumentid,instrument 3"
        new_slugs = dict(self.default_url_slugs)
        url = '/opus/__normalizeurl.json?order=-instrumentid,instrument'
        new_slugs['order'] = '-instrument'
        self._run_url_slugs_equal(url, new_slugs)
    ...
    def test__api_normalizeurl_order_instrumentid_instrumentid(self):
        "/__normalizeurl: order instrumentid,instrumentid"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_order_productid(self):
        "/__normalizeurl: order productid"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_order_ringobsid(self):
        "/__normalizeurl: order ringobsid"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_order_not_viewable(self):
        "/__normalizeurl: order not viewable"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_order_observationduration(self):
        "/__normalizeurl: order observationduration"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_order_observationduration1(self):
        "/__normalizeurl: order observationduration1"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_order_rightasc1(self):
        "/__normalizeurl: order rightasc1"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_multi_good_1(self):
        "/__normalizeurl: search multi good 1"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_multi_good_2(self):
        "/__normalizeurl: search multi good 2"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_multi_good_12(self):
        "/__normalizeurl: search multi good 12"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_multi_good_1_qtype_only(self):
        "/__normalizeurl: search multi good 1 qtype only"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_multi_good_2_qtype_all(self):
        "/__normalizeurl: search multi good 2 qtype all"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_multi_good_12_qtype_any(self):
        "/__normalizeurl: search multi good 12 qtype any"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_multi_good_12_qtype_only(self):
        "/__normalizeurl: search multi good 12 qtype only"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_single_good_1(self):
        "/__normalizeurl: search single good 1"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_single_good_2(self):
        "/__normalizeurl: search single good 2"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_single_good_12(self):
        "/__normalizeurl: search single good 12"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_single_good_1_qtype_only(self):
        "/__normalizeurl: search single good 1 qtype only"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_single_good_2_qtype_all(self):
        "/__normalizeurl: search single good 2 qtype"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_single_good_12_qtype_any(self):
        "/__normalizeurl: search single good 12 qtype any"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_single_good_12_qtype_only(self):
        "/__normalizeurl: search single good 12 qtype only"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_string_good(self):
        "/__normalizeurl: search string good"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_string_bad_1(self):
        "/__normalizeurl: search string bad 1"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_string_bad_2(self):
        "/__normalizeurl: search string bad 2"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_string_good_qtype_contains(self):
        "/__normalizeurl: search string good qtype contains"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_string_good_qtype_matches(self):
        "/__normalizeurl: search string good qtype matches"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_string_good_qtype_begins(self):
        "/__normalizeurl: search string good qtype begins"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_string_good_qtype_ends(self):
        "/__normalizeurl: search string good qtype ends"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_string_good_qtype_excludes(self):
        "/__normalizeurl: search string good qtype excludes"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_mult_good(self):
        "/__normalizeurl: search mult good"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_mult_bad_1(self):
        "/__normalizeurl: search mult bad 1"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_mult_bad_2(self):
        "/__normalizeurl: search mult bad 2"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_mult_bad_12(self):
        "/__normalizeurl: search mult bad 12"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_mult_bad_qtype_only(self):
        "/__normalizeurl: search mult bad qtype only"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_multi_bad_1(self):
        "/__normalizeurl: search multi bad 1"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_multi_bad_2(self):
        "/__normalizeurl: search multi bad 2"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_multi_good_1_bad_2(self):
        "/__normalizeurl: search multi good 1 bad 2"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_multi_bad_1_good_2(self):
        "/__normalizeurl: search multi bad 1 good 2"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_multi_bad_1_bad_2(self):
        "/__normalizeurl: search multi bad 1 bad 2"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_multi_good_1_bad_qtype(self):
        "/__normalizeurl: search multi good 1 bad qtype"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_single_bad_1(self):
        "/__normalizeurl: search single bad 1"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_single_bad_2(self):
        "/__normalizeurl: search single bad 2"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_single_good_1_bad_2(self):
        "/__normalizeurl: search single good 1 bad 2"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_single_bad_1_good_2(self):
        "/__normalizeurl: search single bad 1 good 2"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_single_bad_1_bad_2(self):
        "/__normalizeurl: search single bad 1 bad 2"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_single_good_1_bad_qtype(self):
        "/__normalizeurl: search single good 1 bad qtype"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_string_bad_qtype(self):
        "/__normalizeurl: search string bad qtype"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_multi_old_1(self):
        "/__normalizeurl: search multi old 1"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_mult_old_2(self):
        "/__normalizeurl: search multi old 2"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_multi_old_12(self):
        "/__normalizeurl: search multi old 12"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_multi_mix_new_old(self):
        "/__normalizeurl: search multi mix new 1 old 2"
    ...
    def test__api_normalizeurl_search_multi_mix_old_new(self):
        "/__normalizeurl: search multi mix old 1 new 2"
    ...
    def test__api_normalizeurl_search_multi_dup_old_1(self):
        "/__normalizeurl: search multi dup old 1"
    ...
    def test__api_normalizeurl_search_multi_dup_old_2(self):
        "/__normalizeurl: search multi dup old 2"
    ...
    def test__api_normalizeurl_search_multi_old_1_old_qtype(self):
        "/__normalizeurl: search multi old 1 old qtype"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_multi_old_1_new_qtype(self):
        "/__normalizeurl: search multi old 1 new qtype"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_multi_new_1_old_qtype(self):
        "/__normalizeurl: search multi new 1 old qtype"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_multi_new_1_new_qtype(self):
        "/__normalizeurl: search multi new 1 new qtype"
        new_slugs = dict(self.default_url_slugs)
    ...
    def test__api_normalizeurl_search_not_searchable(self):
        "/__normalizeurl: search not searchable"
    ...
    def test__api_normalizeurl_search_ringobsid(self):
        "/__normalizeurl: search ringobsid"
    ...
    def test__api_normalizeurl_real_1(self):
        ...
        expected = {"new_url": "mission=Voyager&planet=Saturn&time1=1980-09-27T02:16:00.000&time2=1980-09-28T02:17:00.000&qtype-time=any&observationtype=Image&cols=opusid,instrument,planet,target,time1,observationduration&widgets=time,mission,planet,observationtype&order=time1,opusid&view=detail&browse=gallery&startobs=1&cart_browse=gallery&detail=co-iss-n1460961026", "new_slugs": [{"mission": "Voyager"}, {"planet": "Saturn"}, {"time1": "1980-09-27T02:16:00.000"}, {"time2": "1980-09-28T02:17:00.000"}, {"qtype-time": "any"}, {"observationtype": "Image"}, {"cols": "opusid,instrument,planet,target,time1,observationduration"}, {"widgets": "time,mission,planet,observationtype"}, {"order": "time1,opusid"}, {"view": "detail"}, {"browse": "gallery"}, {"startobs": 1}, {"cart_browse": "gallery"}, {"detail": "co-iss-n1460961026"}], "msg": "<p>Your URL is from a previous version of OPUS. It has been adjusted to conform to the current version.</p><br><p>We found the following issues with your bookmarked URL:</p><br><ul><li>Your URL uses the old defaults for selected metadata; they have been replaced with the new defaults.</li><li>Search field \"Mission\" has search parameters but is not listed as a displayed search field; it has been added to the displayed search field list.</li><li>Search field \"Planet\" has search parameters but is not listed as a displayed search field; it has been added to the displayed search field list.</li><li>Search field \"Observation Type\" has search parameters but is not listed as a displayed search field; it has been added to the displayed search field list.</li><li>Your URL uses the old defaults for sort order; they have been replaced with the new defaults.</li><li>You appear to be using an obsolete RINGOBS_ID (S_IMG_CO_ISS_1460961026_N) instead of the equivalent new OPUS_ID (co-iss-n1460961026); it has been converted for you.</li><li>Search query type \"Volume ID\" refers to a search field that is not being used; it has been ignored.</li></ul><br><p>We strongly recommend that you replace your old bookmark with the updated URL in your browser so that you will not see this message in the future.</p>"}
        self._run_json_equal(url, expected)

    def test__api_normalizeurl_real_2(self):
        "/__normalizeurl: real 2"
    ...
    def test__api_normalizeurl_real_3(self):
        "/__normalizeurl: real 3"
        url = '/opus/__normalizeurl.json?mission=Cassini&target=Jupiter,Ganymede,Europa,Himalia,Callisto,Io&instrument=Cassini+ISS&view=browse&browse=gallery&colls_browse=gallery&page=1&gallery_data_viewer=true&limit=100&order=time1&cols=opusid,instrumentid,planet,target,time1,observationduration&widgets=instrument,mission,planet,target&widgets2=&detail='
        expected = {"new_url": "instrument=Cassini ISS&mission=Cassini&target=Callisto,Europa,Ganymede,Himalia,Io,Jupiter&cols=opusid,instrument,planet,target,time1,observationduration&widgets=instrument,mission,planet,target&order=time1,opusid&view=browse&browse=gallery&startobs=1&cart_browse=gallery&detail=", "new_slugs": [{"instrument": "Cassini ISS"}, {"mission": "Cassini"}, {"target": "Callisto,Europa,Ganymede,Himalia,Io,Jupiter"}, {"cols": "opusid,instrument,planet,target,time1,observationduration"}, {"widgets": "instrument,mission,planet,target"}, {"order": "time1,opusid"}, {"view": "browse"}, {"browse": "gallery"}, {"startobs": 1}, {"cart_browse": "gallery"}, {"detail": ""}], "msg": "<p>Your URL is from a previous version of OPUS. It has been adjusted to conform to the current version.</p><br><p>We found the following issues with your bookmarked URL:</p><br><ul><li>Your URL uses the old defaults for sort order; they have been replaced with the new defaults.</li><li>The OPUS_ID or RINGOBS_ID specified for the \"detail\" tab was not found in the current database; it has been ignored.</li></ul><br><p>We strongly recommend that you replace your old bookmark with the updated URL in your browser so that you will not see this message in the future.</p>"}
        self._run_json_equal(url, expected)

    def test__api_normalizeurl_real_4(self):
        "/__normalizeurl: real 4"
        ...
        expected = {"new_url": "mission=Voyager&observationtype=Image&planet=Saturn&time1=1980-09-27T02:16:00.000&time2=1980-09-28T02:17:00.000&qtype-time=any&cols=opusid,instrument,planet,target,time1,observationduration&widgets=time,mission,planet,observationtype&order=time1,opusid&view=detail&browse=gallery&startobs=1&cart_browse=gallery&detail=co-iss-n1460961026", "new_slugs": [{"mission": "Voyager"}, {"observationtype": "Image"}, {"planet": "Saturn"}, {"time1": "1980-09-27T02:16:00.000"}, {"time2": "1980-09-28T02:17:00.000"}, {"qtype-time": "any"}, {"cols": "opusid,instrument,planet,target,time1,observationduration"}, {"widgets": "time,mission,planet,observationtype"}, {"order": "time1,opusid"}, {"view": "detail"}, {"browse": "gallery"}, {"startobs": 1}, {"cart_browse": "gallery"}, {"detail": "co-iss-n1460961026"}], "msg": None}
        self._run_json_equal(url, expected)
