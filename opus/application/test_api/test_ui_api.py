...
class ApiUITests(TestCase, ApiTestHelper):
    ...
    def test__api_normalizeurl_real_5(self):
        ...
        expected = {"new_url": "mission=Voyager&observationtype=Image&planet=Saturn&time1=1980-09-27T02:16:00.000&time2=1980-09-28T02:17:00.000&qtype-time=any&cols=opusid,instrument,planet,target,time1,observationduration&widgets=time,mission,planet,observationtype&order=time1,opusid&view=detail&browse=gallery&startobs=1&cart_browse=gallery&detail=", "new_slugs": [{"mission": "Voyager"}, {"observationtype": "Image"}, {"planet": "Saturn"}, {"time1": "1980-09-27T02:16:00.000"}, {"time2": "1980-09-28T02:17:00.000"}, {"qtype-time": "any"}, {"cols": "opusid,instrument,planet,target,time1,observationduration"}, {"widgets": "time,mission,planet,observationtype"}, {"order": "time1,opusid"}, {"view": "detail"}, {"browse": "gallery"}, {"startobs": 1}, {"cart_browse": "gallery"}, {"detail": ""}], "msg": None}
        self._run_json_equal(url, expected)
