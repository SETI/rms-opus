...
def _time1_helper(index, **kwargs):
...
def populate_time1_from_index(**kwargs):
    return _time1_helper('index_row', **kwargs)

def populate_time1_from_supp_index(**kwargs):
    return _time1_helper('supp_index_row', **kwargs)

def _time2_helper(index, **kwargs):
    metadata = kwargs['metadata']
    index_row = metadata[index]
...
def populate_time2_from_index(**kwargs):
    return _time2_helper('index_row', **kwargs)

def populate_time2_from_supp_index(**kwargs):
    return _time2_helper('supp_index_row', **kwargs)
