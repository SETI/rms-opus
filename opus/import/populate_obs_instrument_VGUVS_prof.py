...
def populate_obs_mission_voyager_VGUVS_ert1_OCC(**kwargs):
    return None

def populate_obs_mission_voyager_VGUVS_ert2_OCC(**kwargs):
    return None

def populate_obs_mission_voyager_VGUVS_spacecraft_clock_count1_OCC(**kwargs):
    metadata = kwargs['metadata']
    index_row = metadata['index_row']
...
def populate_obs_mission_voyager_VGUVS_spacecraft_clock_count2_OCC(**kwargs):
    metadata = kwargs['metadata']
    index_row = metadata['index_row']
...
def populate_obs_mission_voyager_VGUVS_sequence_id_OCC(**kwargs):
    metadata = kwargs['metadata']
    supp_index_row = metadata['supp_index_row']
...
def populate_obs_instrument_VGUVS_channel_OCC(**kwargs):
    return None

def populate_obs_instrument_VGUVS_observation_type_OCC(**kwargs):
    return 'Occultation Profile'

def populate_obs_instrument_VGUVS_occultation_port_state_OCC(**kwargs):
    return 'N/A'

def populate_obs_instrument_VGUVS_integration_duration_OCC(**kwargs):
    return None
    # return _integration_duration_helper(**kwargs)

def populate_obs_instrument_VGUVS_compression_type_OCC(**kwargs):
    return None

def populate_obs_instrument_VGUVS_slit_state_OCC(**kwargs):
    return 'NULL'

def populate_obs_instrument_VGUVS_test_pulse_state_OCC(**kwargs):
    return None

def populate_obs_instrument_VGUVS_dwell_time_OCC(**kwargs):
    return None

def populate_obs_instrument_VGUVS_band1_OCC(**kwargs):
    return None

def populate_obs_instrument_VGUVS_band2_OCC(**kwargs):
    return None

def populate_obs_instrument_VGUVS_band_bin_OCC(**kwargs):
    return None

def populate_obs_instrument_VGUVS_line1_OCC(**kwargs):
    return None

def populate_obs_instrument_VGUVS_line2_OCC(**kwargs):
    return None

def populate_obs_instrument_VGUVS_line_bin_OCC(**kwargs):
    return None

def populate_obs_instrument_VGUVS_samples_OCC(**kwargs):
    return None
