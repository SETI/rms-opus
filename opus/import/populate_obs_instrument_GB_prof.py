...
def _GB_filespec_helper(**kwargs):
...
def populate_obs_general_GB_opus_id_PROF(**kwargs):
    filespec = _GB_filespec_helper(**kwargs)
...
def populate_obs_general_GB_primary_filespec_PROF(**kwargs):
    return _GB_filespec_helper(**kwargs)

def populate_obs_pds_GB_primary_filespec_PROF(**kwargs):
    return _GB_filespec_helper(**kwargs)
