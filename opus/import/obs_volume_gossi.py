...
# obs_volume_gossi.py
#
# Defines the ObsVolumeGOSSI class, which encapsulates fields in the
...
from obs_volume_galileo_helper import ObsVolumeGalileoHelper
...
class ObsVolumeGOSSI(ObsVolumeGalileoHelper):
    ...
    ############################################
    ### OVERRIDE FROM ObsVolumeGalileoHelper ###
    ############################################
