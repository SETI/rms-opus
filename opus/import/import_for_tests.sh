...
python main_opus_import.py --do-it-all --import-fake-images COCIRS_5408
...
python main_opus_import.py --do-it-all --import-fake-images HSTJ0_9975,HSTN0_7243,HSTO0_7308,HSTU0_5642
