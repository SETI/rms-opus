...
python main_opus_import.py --import-check-duplicate-id --do-all-import GO_0016,GO_0017,GO_0018 $1 --override-pds3-data-dir ~/Dropbox\ \(SETI\ Institute\)/Shared-OPUS/pdsdata/rf_240529_gossi/holdings
