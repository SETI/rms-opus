################################################################################
# obs_volume_new_horizons_helper.py
#
# Defines the ObsVolumeNewHorizonsHelper class, which encapsulates fields in the
...
class ObsVolumeNewHorizonsHelper(ObsCommon):
